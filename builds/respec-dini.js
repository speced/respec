((window.respecVersion = "36.0.0"),
  (function () {
    ...
    const P = Object.entries(T).reduce((e, [t, n]) => ((e[n] = t), e), {});
    new (class {
      type;
      literal;
      comments;
      ...
      toString(e = 0) {
        const t = [
          `${"  ".repeat(e)}${this.constructor.name}: ${P[this.type]} (${this.type})`,
        ];
        ("" !== this.whitespace &&
    ...
    var H = (() => {
      ...
      me = B(fe, "u").replace(/punct/g, le).getRegex(),
      ge = B(fe, "u").replace(/punct/g, pe).getRegex(),
      be =
      ...
      _e = B(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/)
        ...
        .getRegex(),
      Ee = B(ee).replace("(?:--\x3e|$)", "--\x3e").getRegex(),
      Se = B(
      ...
      Pe = {
        ...
        punctuation: de,
        reflink: Ae,
        reflinkSearch: B("reflink|nolink(?!\\()", "g")
          .replace("reflink", Ae)
          .replace("nolink", Te)
          .getRegex(),
        tag: Se,
      ...
      Ie = { normal: Pe, gfm: Oe, breaks: je, pedantic: Ne },
      ze = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
    ...
    var Ge = class {
      ...
      Ze = class e {
        ...
        constructor(e) {
          ...
          let t = { other: F, block: De.normal, inline: Ie.normal };
          (this.options.pedantic
            ? ((t.block = De.pedantic), (t.inline = Ie.pedantic))
            : this.options.gfm &&
              ((t.block = De.gfm),
              this.options.breaks
                ? (t.inline = Ie.breaks)
      ...
      Qe = class {
        ...
        provideParser(e = this.block) {
          return e ? Ye.parse : Ye.parseInline;
        }
      },
      Je = new (class {
        defaults = {
        ...
        use(...e) {
          ...
          return (
            e.forEach(e => {
              ...
              if (e.tokenizer) {
                let t = this.defaults.tokenizer || new Ge(this.defaults);
      ...
      at = (function (e) {
        ...
        var M,
          ...
          Z =
            ...
            (U = M.createDocumentFragment())[q](M[H]("g")),
            U[q](M[H]("")),
            (W ? M[F](U, !0) : U[B](!0)).childNodes.length < 2
              ? function e(t, n) {
                  for (
                    var r = t[B](), o = t.childNodes || [], i = o.length, s = 0;
                    n && s < i;
                    s++
                  )
                    r[q](e(o[s], n));
        ...
        try {
          ((V = e.createElement("template")),
            ...
            ("content" in V &&
              ((V.innerHTML = "<p " + G + '="' + X + '"></p>'),
              V.content.childNodes[0].getAttribute(G) == X)) ||
              ((X = "_dt: " + X.slice(1, -1) + ";"), (Y = !0)));
        } catch (u) {}
        var Q = "\x3c!--" + X + "--\x3e",
          J = 8,
          ee = 1,
        ...
        var Ae,
          ...
          Re =
            ((Ae = [].slice),
            ((Te = Pe.prototype).ELEMENT_NODE = 1),
            (Te.nodeType = 111),
                    ...
                    if (((i = !1), j((n = a))))
                      if (0 === a.length)
                        ...
                        switch (typeof a[0]) {
                          ...
                          case "object":
                            if (
                              (j(a[0]) && (a = a.concat.apply([], a)), De(a[0]))
                            ) {
                      ...
                      "ELEMENT_NODE" in a
                        ? (t = f(
                            e.parentNode,
                            t,
                            11 === a.nodeType ? Ge.call(a.childNodes) : [a],
                            r
                          ))
                        : De(a)
                          ? a.then(s)
        ...
        function Qe(e) {
          for (var t = arguments.length, n = [Ye(e)], r = 1; r < t; )
            n.push(arguments[r++]);
          return n;
        }
        var Je = new n(),
            ...
            for: {
              ...
              value: function (e, t) {
                return (function (e, t, r, o) {
                  ...
                  this,
                  st.get(e) || ((r = e), (o = new v()), st.set(r, o), o),
                  e,
                  null == t ? "default" : t
                );
                var r, o;
...
.respec-plugin{text-align:right;color:rgb(120,120,120,.5);font-size:.6em}`;
    ...
    const En = ft`<div id="respec-ui" class="removeOnSave" hidden></div>`,
      Sn = ft`<ul
  id="respec-menu"
  role="menu"
...
>
  ❌
    ...
    let Ln, An;
    window.addEventListener("load", () => jn(Sn));
    const Tn = [],
      Rn = [],
      Pn = {};
    (rn("start-all", () => document.body.prepend(En), { once: !0 }),
      rn("end-all", () => document.body.prepend(En), { once: !0 }));
  ...
  ></button>`;
    ...
    const zn = {
      ...
      <span class="respec-cmd-icon" aria-hidden="true">${r}</span> ${e}…
        ...
        return (s.addEventListener("click", t), Sn.appendChild(s), i);
      },
      error(e) {
        In(e, Tn, "error", "ReSpec Errors");
      },
      warning(e) {
    ...
    function Mn(e) {
      ...
      const t = e.plugin
          ...
          : "",
        n = e.hint
          ? `\n${vn(`<p class="respec-hint"><strong>How to fix:</strong> ${en(e.hint)}`, { inline: !e.hint.includes("\n") })}\n`
          : "",
        r = Array.isArray(e.elements)
          ? `<p class="respec-occurrences">Occurred <strong>${e.elements.length}</strong> times at:</p>\n    ${vn(e.elements.map(qn).join("\n"))}`
          : "",
        o = e.details ? `\n\n<details>\n${e.details}\n</details>\n` : "";
      var i;
      return `${vn(`**${((i = e.message), i.replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/</g, "&lt;"))}**`, { inline: !0 })}${n}${r}${o}${t}`;
    }
    function qn(e) {
    ...
    var Gn = Object.freeze({
      ...
      name: "dini/defaults",
      run: function (e) {
        const t = !1 !== e.lint && { ...Wn.lint, ...Vn.lint, ...e.lint };
        (Object.assign(e, { ...Wn, ...Vn, ...e, lint: t }),
          Object.assign(
            e,
            (function (e) {
...
body:has(input[name=color-scheme][value=dark]:checked){color-scheme:dark}`;
    ...
    const Qn = (function () {
      ...
      for (const n of e.map(Et)) t.appendChild(n);
      return t;
    })();
    (Qn.appendChild(
      (function () {
    ...
    function pr(e) {
      if (!e.key) {
        ...
        return (Kt(t, "core/templates/show-link"), void console.warn(t, e));
      }
      return ft`
        ...
        function (e, t) {
          ...
          return e.retiredDate &&
            ...
            : !(
                ...
                (e.url &&
                  e.mailto &&
                  Kt(`${i} Has both "url" and "mailto" property.`, gr, {
  ...
  >
    ...
    const kr = "dini/templates/headers",
      xr = "https://creativecommons.org/licenses/by/4.0/legalcode",
      $r = Pt({
        en: {
          author: "Author:",
          authors: "Authors:",
    ...
    var _r = e => ft`<div class="head">
    ${(e.logos ?? []).map(mr)} ${document.querySelector("h1#title")}
    ${(function (e) {
    ...
    <dl>
      <dt>${e.multipleEditors ? $r.editors : $r.editor}</dt>
      ${vr(e, "editors")}
      ${
        Array.isArray(e.formerEditors) && e.formerEditors.length > 0
          ? ft`
            <dt>
              ${e.multipleFormerEditors ? $r.former_editors : $r.former_editor}
            </dt>
            ${vr(e, "formerEditors")}
          `
          : ""
      ...
      ${
        e.authors
          ? ft`
            <dt>${e.multipleAuthors ? $r.authors : $r.author}</dt>
            ${vr(e, "authors")}
          `
          : ""
      }
    ...
    ${(function (e) {
      ...
      if (e.hasOwnProperty("overrideCopyright")) {
        Kt("The `overrideCopyright` configuration option is deprecated.", kr, {
          hint: 'Please use `<p class="copyright">` instead.',
        });
      }
      return e.overrideCopyright
        ? [e.overrideCopyright]
        : ft`<p class="copyright">
        Dieses Dokument ist lizensiert unter
        ${((n = "Creative Commons Attribution 4.0 International Public License"), (r = xr), (o = "subfoot"), ft`<a rel="license" href="${r}" class="${o}">${n}</a>`)}.
      </p>`;
      var n, r, o;
    })(e)}
    <hr />
  </div>`;
    const Er = "dini/headers",
      Sr = new Intl.DateTimeFormat(["de-DE"], {
        timeZone: "UTC",
        year: "numeric",
        month: "long",
        day: "2-digit",
      }),
      Cr = { unofficial: "Entwurf vom", base: "Spezifikation vom" };
    var Lr = Object.freeze({
      __proto__: null,
      name: Er,
      run: function (e) {
        if (
          ...
          Zt("Missing required configuration: `specStatus`", Er);
        }
        ...
        const t = function (e) {
          if (!e.name) {
            Zt("All authors and editors must have a name.", Er);
          }
          if (e.orcid)
            try {
              e.orcid = (function (e) {
              ...
              (Zt(`"${e.orcid}" is not an ORCID. ${t.message}`, Er),
                delete e.orcid);
            }
        };
        ...
        if (!e.editors || 0 === e.editors.length) {
          Zt("At least one editor is required", Er);
        }
        (e.formerEditors.length && e.formerEditors.forEach(t),
          ...
          (e.alternateFormats || []).forEach(e => {
            if (!e.uri || !e.label) {
              Zt("All alternate formats must have a uri and a label.", Er);
            }
          }),
          e.copyrightStart &&
            e.copyrightStart == e.publishYear &&
            (e.copyrightStart = ""),
          (e.textStatus = Cr[e.specStatus]),
    ...
    var Dr = String.raw`:root{--assertion-border:#aaa;--assertion-bg:#eee;--assertion-text:black}
...
:root{--assertion-border:#444;--assertion-bg:var(--borderedblock-bg);--assertion-text:var(--text)}
    ...
    var Ir = Object.freeze({
      ...
      run: function () {
        ...
        ((t.textContent = Dr), document.head.appendChild(t));
      },
    });
    const zr = /^[a-z]+(\s+[a-z]+)+\??$/,
      Mr = /\B"([^"]*)"\B/,
  ...
  >`;
    ...
    const ro = new Set(["alias", "reference"]),
      oo = (async function () {
    ...
    const io = {
        ...
        async has(e, t) {
          if (!ro.has(e)) throw new TypeError(`Invalid type: ${e}`);
        ...
        async addAll(e, t) {
          ...
          const r = [...ro].flatMap(e => n[e].map(t => this.add(e, t)));
          await Promise.all(r);
        },
        async add(e, t) {
          if (!ro.has(e)) throw new TypeError(`Invalid type: ${e}`);
      ...
      so = {},
      ao = new URL("https://api.specref.org/bibrefs?refs="),
      lo = Et({ hint: "dns-prefetch", href: ao.origin });
    let co;
    document.head.appendChild(lo);
    const uo = new Promise(e => {
      co = e;
    });
    async function po(e, t = { forceUpdate: !1 }) {
      const n = [...new Set(e)].filter(e => e.trim());
      if (!n.length || !1 === navigator.onLine) return null;
      let r;
      try {
        r = await fetch(ao.href + n.join(","));
      } catch (e) {
    ...
    async function ho(e) {
      ...
      const n = t[e];
      return n.aliasOf ? await ho(n.aliasOf) : n;
    }
    var fo = Object.freeze({
      ...
      Plugin: class {
        ...
        async run() {
          ...
          (r.forEach(e => {
            ...
            o.hasData.forEach(e => {
              e.data && (so[e.id] = e.data);
            }));
          const i = o.noData.map(e => e.id);
          if (i.length) {
            const e = await po(i, { forceUpdate: !0 });
            Object.assign(so, e);
          }
          (Object.assign(so, this.conf.localBiblio),
            (() => {
              co(this.conf.biblio);
            })());
        }
      ...
      name: "core/biblio",
      resolveRef: ho,
      updateFromNetwork: po,
    });
    const mo = "core/render-biblio";
    function go(e) {
      return `bib-${jt(e)}`;
    }
    const bo = Pt({
    ...
    function ko(e, t) {
      const { goodRefs: n, badRefs: r } = (function (e) {
        ...
        s = ft`<section>
    <h3>${t}</h3>
    <dl class="bibliography">${i.map(_o)}</dl>
  </section>`;
      Dt(s, "", t);
      const a = (function (e) {
        const t = new Map();
      ...
      return (
        ...
        (function (e) {
          for (const { ref: t } of e) {
            const e = [
              ...document.querySelectorAll(`a.bibref[href="#${go(t)}"]`),
            ].filter(
              ({ textContent: e }) => e.toLowerCase() === t.toLowerCase()
            );
            Zt(`Reference "[${t}]" not found.`, mo, {
    ...
    function xo(e) {
      ...
      for (; t && t.aliasOf; )
        ...
        } else ((n = t.aliasOf), (t = so[n]), r.add(n));
      return (
  ...
  `;
    ...
    function Eo(e) {
      ...
      if (
        ...
        if (!Array.isArray(e.authors)) {
          ...
          (Zt(t, mo, { hint: n }), (e.authors = [e.authors]));
        }
        e.authors.length &&
          ((t += e.authors.join("; ")),
          e.etAl && (t += " et al"),
      ...
      return (
        e.publisher && (t = `${t} ${vo(e.publisher)} `),
        e.date && (t += `${e.date}. `),
        e.status && (t += `${yo.get(e.status) || e.status}. `),
      ...
      run: function (e) {
        ...
        if (
          (document.querySelector("section#references > :is(h2, h1)") ||
            r.prepend(ft`<h1>${bo.references}</h1>`),
          r.classList.add("appendix"),
          n.length)
        ) {
          const e = ko(n, bo.norm_references);
          r.appendChild(e);
        }
        if (t.length) {
          const e = ko(t, bo.info_references);
          r.appendChild(e);
        }
    ...
    const Co = "core/inlines",
      Lo = {},
      Ao = e => new RegExp(e.map(e => e.source).join("|")),
      To = Pt({
        en: {
          rfc2119Keywords: () =>
            Ao([
  ...
  >`;
    ...
    var Xo = Object.freeze({
      ...
      run: function (e) {
        ...
        (document.normalize(),
          ...
          (e.normativeReferences = new Ht()),
          (e.informativeReferences = new Ht()),
          e.respecRFC2119 || (e.respecRFC2119 = Lo));
        ...
        const r = t.size
          ...
          i = To.rfc2119Keywords(),
          s = new RegExp(
            `(${Ao([i, Po, zo, No, Oo, jo, Do, Ro, Io, ...(r ? [r] : [])]).source})`
          );
        for (const n of o) {
    ...
    function Jo(e, t) {
      ...
      const i = n.length > 1,
        s = ft`
    <h1>${Qo.conformance}</h1>
    <p>${Qo.normativity}</p>
    ${n.length ? Qo.keywordInterpretation(r, i) : null}
  `;
    ...
    var ei = Object.freeze({
      ...
      run: function (e) {
        ...
        if (
          (t && !t.classList.contains("override") && Jo(t, e),
          !t && Object.keys(Lo).length)
        ) {
          Kt(
    ...
    const ri = new Vt();
    function oi(e, t) {
      for (const n of t) (ri.has(n) || ri.set(n, new Set()), ri.get(n)?.add(e));
    }
    const ii = "core/dfn",
      si = new Map([
        ...
        ["element", { requiresFor: !1, validator: ti }],
        ["element-attr", { requiresFor: !1, validator: ti }],
        [
          "element-state",
          {
            requiresFor: !0,
        ...
        ["event", { requiresFor: !1, validator: ni }],
        ...
        ["scheme", { requiresFor: !1, validator: ni }],
        [
          "permission",
          {
            requiresFor: !1,
    ...
    function li(e, t) {
      let n = "";
      switch (!0) {
        case ai.some(t => e.classList.contains(t)):
          ((n = [...e.classList].find(e => si.has(e)) ?? ""),
            (function (e, t, n) {
              const r = si.get(t);
              if (r?.requiresFor && !n.dataset.dfnFor) {
                ...
                Zt(e, ii, { hint: i, elements: [n] });
              }
              r?.validator && r.validator(e, t, n, ii);
            })(t, n, e));
          break;
        case Br.test(t):
          n = (function (e, t) {
            ...
            if (!o.includes(i) || r !== i) {
              const n = Jt`Invalid ${"[data-dfn-type]"} attribute on internal slot.`,
                i = `The only allowed types are: ${Qt(o, { quotes: !0 })}. The slot "${e}" seems to be a "${Yt(r)}"?`;
              return (Zt(n, ii, { hint: i, elements: [t] }), "dfn");
            }
            return i;
          })(t, e);
      }
          ...
          .forEach(e => {
            ...
            if (r.size) {
              const t = e.dataset.plurals ? e.dataset.plurals.split("|") : [],
                n = [...new Set([...t, ...r])];
              ((e.dataset.plurals = n.join("|")), oi(e, n));
            }
          });
      },
    });
    var pi = String.raw`span.example-title{text-transform:none}
...
aside.example div.example{border-left-width:.1em;border-color:#999;background:#fff}`;
    ...
    <a class="self-link">${hi.example}<bdi>${r}</bdi></a
    >${o}
  </div>`;
    }
    ...
    var gi = String.raw`.issue-label{text-transform:initial}
...
.issue a.respec-gh-label{padding:5px;margin:0 2px 0 2px;font-size:10px;text-transform:none;text-decoration:none;font-weight:700;border-radius:4px;position:relative;bottom:2px;border:none;display:inline-block}`;
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                Kt(`Failed to fetch issue number ${u}.`, bi);
              }
  ...
  >`;
        ...
        (function (e) {
          ...
          (e.hasChildNodes()
            ? t.append(e)
            : t.append(ft`<p>${yi.no_issues_in_spec}</p>`),
            (!n || (n && n !== t.firstElementChild)) &&
              t.insertAdjacentHTML(
                "afterbegin",
                `<h1>${yi.issue_summary}</h1>`
              ));
        })(o));
    }
    ...
    var Ei = Object.freeze({
      ...
      ><bdi lang="${_i}">${$i.best_practice}${t + 1}</bdi></a
    >`;
            if (n) {
    ...
    var Li = Object.freeze({
      ...
      >${Ci.fig}<bdi class="figno">${n + 1}</bdi></a
    >`,
                        " "
                      ));
                  })(t, r, n),
    ...
    <a class="tocxref" href="${`#${e}`}">${n.childNodes}</a>
                  ...
                  Kt("Found a `<figure>` without a `<figcaption>`.", Si, {
                    elements: [t],
                  });
                }
              }),
    ...
    const Ai = "core/data-cite",
      Ti = "__SPEC__";
    async function Ri(e) {
      const { key: t, frag: n, path: r, href: o } = e;
      let i = "",
        s = "";
      if (t === Ti) i = document.location.href;
      else {
        const e = await ho(t);
        if (!e) return null;
        ((i = e.href ?? ""), (s = e.title));
      ...
      switch (e.localName) {
        ...
        case "dfn": {
          ...
          if ("export" in e.dataset) {
            (Zt("Exporting a linked external definition is not allowed.", Ai, {
    ...
    function Di(e) {
      ...
      if ((n ?? "").startsWith("#") && !r) {
        const r =
            ...
            null,
          { key: o, isNormative: i } = r ? Di(r) : { key: Ti, isNormative: !1 };
        return (
          (t.cite = i ? o : `?${o}`),
    ...
    var zi = Object.freeze({
      ...
      run: async function () {
        ...
        await (async function (e) {
          const t = e
              .map(Di)
              .map(async e => ({ entry: e, result: await ho(e.key) })),
            n = (await Promise.all(t))
              .filter(({ result: e }) => null === e)
              .map(({ entry: { key: e } }) => e),
            r = await po(n);
          r && Object.assign(so, r);
        })([...e]);
        for (const t of e) {
    ...
    var Zi = Object.freeze({
      __proto__: null,
      name: Mi,
      possibleExternalLinks: qi,
      run: async function (e) {
        const t = (function () {
            const e = new Vt();
            for (const t of ri.keys()) {
              const { result: n, duplicates: r } = Fi(t);
              (e.set(t, n),
                r.length > 0 &&
                  Zt(Hi.duplicateMsg(t), Mi, {
                    title: Hi.duplicateTitle,
                    elements: r,
                  }));
            }
            return e;
        ...
        for (const e of r) {
          ...
          if (r) {
            Ui(e, r, t) || qi.push(e);
          } else "" === e.dataset.cite ? n.push(e) : qi.push(e);
        }
        (Gi(n),
          (function (e) {
            const { shortName: t = "" } = e,
            ...
            for (const t of r) {
              t.dataset.cite = (t.dataset.cite ?? "").replace(n, `$1${Ti}$2`);
              const { key: r, isNormative: o } = Di(t);
              r !== Ti &&
        ...
        await (async function (e, t) {
          ...
          async function o() {
            ...
            try {
              ...
              return (
                Zt("Error loading contributors from GitHub.", Ki, { cause: e }),
                null
              );
            }
          }
    ...
    function ts(e, t, { prefix: n = "" } = {}) {
      ...
      for (const a of e) {
        ...
        let e = a.isIntro ? "" : r ? ns(i - o + 1) : n + i;
    ...
    function rs(e) {
      ...
      for (const e of t) {
        ...
        if (!Qi.includes(r.localName)) continue;
    ...
    var is = Object.freeze({
      ...
      run: function (e) {
        if (
          ...
          const t = ts(rs(document.body), e.maxTocLevel);
          t &&
            (function (e) {
              if (!e) return;
              const t = ft`<nav id="toc"></nav>`,
                n = ft`<h2 class="introductory">${es.toc}</h2>`;
              (Dt(n), t.append(n, e));
              const r =
    ...
    <a href="#title"><abbr title="${es.back_to_top}">&uarr;</abbr></a>
  </p>`;
    ...
    var as = Object.freeze({
      ...
      run: function () {
        Array.from(document.querySelectorAll("section.informative"))
          ...
          .filter(e => null !== e)
          .forEach(e => {
            e.after(ft`<p><em>${ss.informative}</em></p>`);
          });
      },
    });
    const ls = Pt({
    ...
    var fs = Object.freeze({
      ...
      run: function (e) {
        ...
        ${ps.map(t => hs(t, e))}
              ...
              zn.freshModal(ds.save_snapshot, n, t);
            },
          },
...
`,
  ...
  `;
    ...
    const xs =
      "\n  --base: #282c34;\n  --mono-1: #abb2bf;\n  --mono-2: #818896;\n  --mono-3: #5c6370;\n  --hue-1: #56b6c2;\n  --hue-2: #61aeee;\n  --hue-3: #c678dd;\n  --hue-4: #98c379;\n  --hue-5: #e06c75;\n  --hue-5-2: #be5046;\n  --hue-6: #d19a66;\n  --hue-6-2: #e6c07b;\n";
    var $s = String.raw`.hljs,body:has(input[name=color-scheme][value=light]:checked) .hljs,head:not(:has(meta[name=color-scheme][content~=dark]))+body .hljs{--base:#fafafa;--mono-1:#383a42;--mono-2:#686b77;--mono-3:#717277;--hue-1:#0b76c5;--hue-2:#336ae3;--hue-3:#a626a4;--hue-4:#42803c;--hue-5:#ca4706;--hue-5-2:#c91243;--hue-6:#986801;--hue-6-2:#9a6a01}
@media (prefers-color-scheme:dark){
.hljs{${xs}}
}
body:has(input[name=color-scheme][value=dark]:checked) .hljs{${xs}}
...
.hljs-link{text-decoration:underline}`;
    ...
    const Es = new URL(
      ...
      Ss = Et({ hint: "preload", href: Es, as: "script" });
    async function Cs() {
      try {
        return (
        ...
        return _s("worker/respec-worker.js");
      }
    }
    async function Ls() {
      try {
    ...
    const As = (async function () {
      const [e, t] = await Promise.all([Cs(), Ls()]),
        n = new Blob(
          [
            null !== t
              ? `${t}\n`
    ...
    async function Rs(e) {
      ...
      try {
        o = await (async function (e, t) {
          const n = { action: "highlight", code: e, id: Ts(), languages: t },
            r = await As;
          return (
            r.postMessage(n),
            new Promise((e, t) => {
    ...
    var Ps = Object.freeze({
      ...
      run: async function (e) {
        ...
        if (!t.length) return;
        const n = t.filter(e => e.textContent.trim()).map(Rs);
    ...
    var Is = Object.freeze({
        ...
        for (const t of e) {
          ...
          switch (t.localName) {
            ...
            case "ul":
              ...
              break;
            default:
              Kt(`ReSpec can't sort ${t.localName} elements.`, Ns, {
                elements: [t],
              });
          }
          if (e) {
      ...
      sortDefinitionTerms: Ds,
      sortListItems: js,
    });
    var zs = String.raw`var:hover{text-decoration:underline;cursor:pointer}
...
var.respec-hl{background:0 0;color:#000;box-shadow:unset}
        ...
        ((n.id = "respec-highlight-vars"),
          (n.textContent = await (async function () {
            try {
              ...
              return _s("./src/core/highlight-vars.runtime.js");
            }
          })()),
    ...
    var qs = String.raw`var[data-type]{position:relative}
...
var[data-type]:hover::after,var[data-type]:hover::before{opacity:1}`;
    var Bs = Object.freeze({
      ...
      run: function (e) {
        if (!e.highlightVars) return;
        const t = document.createElement("style");
        ((t.textContent = qs), document.head.appendChild(t));
        let n = null;
        const r = new Map(),
    ...
    var Xs = String.raw`dfn{cursor:pointer}
...
.dfn-panel.docked{position:fixed;left:.5em;top:unset;bottom:2em;margin:0 auto;max-width:calc(100vw - .75em * 2 - .5em - .2em * 2);max-height:30vh;overflow:auto}`;
  ...
  `;
        ...
        ((r.id = "respec-dfn-panel"),
          (r.textContent = await (async function () {
            try {
              ...
              return _s("./src/core/dfn-panel.runtime.js");
            }
          })()),
          document.body.append(r));
      },
    });
    const Js = new Promise((e, t) => {});
    Pt({
      en: {
    ...
    const ea = "rs-changelog",
      ...
      ${{
        any: na(e, t, n, r, o)
          ...
          .catch(e => Zt(e.message, ea, { elements: [this], cause: e }))
          .finally(() => {
    ...
    const ra = [Object.freeze({ __proto__: null, element: ta, name: ea })];
    ...
    const sa = "core/linter-rules/check-charset",
      aa = Pt({
        en: {
    ...
    var la = Object.freeze({
      ...
      run: function (e) {
        ...
        (n.includes("utf-8") && 1 === t.length) ||
          Kt(aa.msg, sa, { hint: aa.hint, elements: [...t] });
      },
    });
    const ca = "no-dfn-in-abstract",
      ua = `core/linter-rules/${ca}`,
      da = Pt({
        en: {
          msg: e =>
      ...
      pa = ["section#abstract", "section#sotd", "section.introductory"].join(
        ", "
      );
    var ha = Object.freeze({
      ...
      run: function (e) {
        ...
        t.forEach(e => {
          ...
          Kt(da.msg(t), ua, { hint: da.hint, elements: [e] });
        });
      },
    });
    const fa = "core/linter-rules/check-punctuation",
      ma = [".", ":", "!", "?"],
      ga = ma.map(e => `"${e}"`).join(", "),
      ba = Pt({
        en: {
          msg: "`p` elements should end with a punctuation mark.",
          hint: `Please make sure \`p\` elements end with one of: ${ga}.`,
        },
        cs: {
          msg: "Elementy `p` by měly končit interpunkčním znaménkem.",
          hint: `Ujistěte se, že elementy \`p\` končí jedním z těchto znaků: ${ga}.`,
        },
      });
    var ya = Object.freeze({
      ...
      run: function (e) {
        ...
        const t = new RegExp(`[${ma.join("")}\\]]$|^ *$`, "m"),
          n = [
            ...document.querySelectorAll("p:not(#back-to-top,#w3c-state)"),
          ].filter(e => !t.test(e.textContent.trim()));
        n.length && Kt(ba.msg, fa, { hint: ba.hint, elements: n });
      },
    });
    const va = "core/linter-rules/local-refs-exist",
      wa = Pt({
        en: {
    ...
    var xa = Object.freeze({
      ...
      run: function (e) {
        ...
        const t = [...document.querySelectorAll("a[href^='#']")].filter(ka);
        t.length && Kt(wa.msg, va, { hint: wa.hint, elements: t });
      },
    });
    const $a = "core/linter-rules/no-headingless-sections",
      _a = Pt({
        en: {
    ...
    var Ea = Object.freeze({
      ...
      run: function (e) {
        ...
        t.length && Kt(_a.msg, $a, { hint: _a.hint, elements: t });
      },
    });
    const Sa = "core/linter-rules/no-unused-vars",
      Ca = Pt({
        en: {
    ...
    var La = Object.freeze({
      ...
      run: function (e) {
        ...
        t.length && Kt(Ca.msg, Sa, { hint: Ca.hint, elements: t });
      },
    });
    const Aa = "core/linter-rules/privsec-section",
      Ta = Pt({
        en: {
    ...
    var Ra = Object.freeze({
      ...
      run: function (e) {
        ...
        e.lint?.["privsec-section"] &&
          ...
          Kt(Ta.msg, Aa, { hint: Ta.hint });
      },
    });
    const Pa = "core/linter-rules/no-http-props",
      Na = Pt({
        en: {
