((window.respecVersion = "36.0.0"),
  (function () {
    ...
    const N = Object.entries(R).reduce((e, [t, n]) => ((e[n] = t), e), {});
    new (class {
      type;
      literal;
      comments;
    ...
    var B = (() => {
      ...
      Ie = { normal: re, gfm: se, pedantic: ie },
      ze = { normal: Ne, gfm: Oe, breaks: je, pedantic: Pe },
      De = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
    ...
    var Ve = class {
        ...
        code(e) {
          ...
          if (t) {
            let e = this.options.pedantic ? t[0] : Ue(t[0]),
            ...
            for (; e.length > 0; ) {
              ...
              if ("list" !== u?.type);
                ...
                ((o[o.length - 1] = i),
                  ...
                  (e = s.substring(o.at(-1).raw.length).split("\n")));
              }
            }
      ...
      Ze = class e {
        ...
        constructor(e) {
          ...
          let t = { other: F, block: Ie.normal, inline: ze.normal };
          (this.options.pedantic
            ? ((t.block = Ie.pedantic), (t.inline = ze.pedantic))
            : this.options.gfm &&
              ((t.block = Ie.gfm),
              this.options.breaks
                ? (t.inline = ze.breaks)
      ...
      Ke = class {
        ...
        image({ href: e, title: t, text: n, tokens: r }) {
          ...
          let s = `<img src="${(e = o)}" alt="${qe(n)}"`;
          return (t && (s += ` title="${qe(t)}"`), (s += ">"), s);
        }
        text(e) {
      ...
      Xe = class {
        ...
        provideParser(e = this.block) {
          return e ? Je.parse : Je.parseInline;
        }
      },
      Ye = new (class {
        defaults = {
        ...
        use(...e) {
          ...
          return (
            e.forEach(e => {
              ...
              if (e.hooks) {
                let t = this.defaults.hooks || new Xe();
                for (let n in e.hooks) {
                  ...
                  let r = n,
                    o = e.hooks[r],
                    s = t[r];
                  Xe.passThroughHooks.has(n)
                    ? (t[r] = e => {
                        if (
                          this.defaults.async &&
                          Xe.passThroughHooksRespectAsync.has(n)
                        )
                          return (async () => {
                    ...
                    : (t[r] = (...e) => {
                        if (this.defaults.async)
                          return (async () => {
                            ...
                            return (!1 === n && (n = await s.apply(t, e)), n);
                          })();
                        let n = o.apply(t, e);
                        return (!1 === n && (n = s.apply(t, e)), n);
                      });
            ...
            if (
              ...
              return (async () => {
                let n = o.hooks ? await o.hooks.preprocess(t) : t,
                  ...
                  s = o.hooks ? await o.hooks.processAllTokens(r) : r;
                o.walkTokens &&
                  (await Promise.all(this.walkTokens(s, o.walkTokens)));
                let i = await (
                  o.hooks
                ...
                return o.hooks ? await o.hooks.postprocess(i) : i;
              })().catch(s);
            try {
    ...
    ((et.options = et.setOptions =
      ...
      (et.defaults = D),
      (et.use = function (...e) {
        return (Ye.use(...e), (et.defaults = Ye.defaults), M(et.defaults), et);
      }),
      (et.walkTokens = function (e, t) {
        return Ye.walkTokens(e, t);
      }),
      (et.parseInline = Ye.parseInline),
      (et.Parser = Je),
      (et.parser = Je.parse),
      (et.Renderer = Ke),
      (et.TextRenderer = Qe),
    ...
    var ot,
      ...
      at = (function (e) {
        ...
        function a(e, t, n, r, o, s, i) {
          ...
          if (a < 1) return -1;
          for (; a <= n - t; ) {
            for (var l = t, c = o; l < n && c < s && i(e[l], r[c]); )
              (l++, c++);
            if (c === s) return t;
            t = l + 1;
          }
        ...
        function f(e, t, n, r) {
          ...
          var v = g === m,
            w = y === b;
          if (v && w) return n;
          if (v && y < b) return (o(d, e, n, y, b, l(d, t, g, f, h)), n);
          if (w && g < m) return (c(d, t, g, m), n);
          var k = m - g,
            x = b - y,
            $ = -1;
          if (k < x) {
          ...
          return (
            k < 2 || x < 2
              ...
              : k == x &&
                ...
                : (function (e, t, n, r, s, i, a, l, u, d, h, f, m) {
                    !(function (e, t, n, r, s, i, a, l, u) {
                      ...
                      (function (e, t, n, r, o, s, i) {
                        ...
                        (function (e, t, n, r, o, s, i, a) {
                          var l = 0,
                            ...
                            d = Array(c);
                          d[0] = -1;
                          for (var h = 1; h < c; h++) d[h] = i;
                          for (var f = o.slice(s, i), m = t; m < n; m++) {
                            var g,
                              b = f.indexOf(e[m]);
                            -1 < b &&
                              -1 < (l = p(d, c, (g = b + s))) &&
        ...
        var $,
          ...
          O = {
            ...
            define: function (e, t) {
              e.indexOf("-") < 0
                ? (e in R || (P = T.push(e)), (R[e] = t))
                : (A[e] = t);
            },
            invoke: function (e, t) {
              for (var n = 0; n < P; n++) {
                var r = T[n];
                if (N.call(e, r)) return R[r](e[r], t);
              }
            },
          },
          j =
        ...
        var M,
          ...
          Z =
            ...
            (U ? M[F](W, !0) : W[H](!0)).childNodes.length < 2
              ? function e(t, n) {
                  for (
                    var r = t[H](), o = t.childNodes || [], s = o.length, i = 0;
                    n && i < s;
                    i++
                  )
                    r[q](e(o[i], n));
        ...
        try {
          ((G = e.createElement("template")),
            ...
            ("content" in G &&
              ((G.innerHTML = "<p " + V + '="' + Q + '"></p>'),
              G.content.childNodes[0].getAttribute(V) == Q)) ||
              ((Q = "_dt: " + Q.slice(1, -1) + ";"), (J = !0)));
        } catch (u) {}
        var X = "\x3c!--" + Q + "--\x3e",
          Y = 8,
          ee = 1,
          ...
          le =
            ...
            se.replace("\\/", "") +
            "))?)",
          ce = new RegExp(ae + ie + le + "+)([" + oe + "]*/?>)", "g"),
          ue = new RegExp(ae + ie + le + "*)([" + oe + "]*/>)", "g"),
              ...
              case ee:
                ...
                (!(function (t, n, r, o) {
                  for (
                    ...
                    var p = c[d++],
                      h = p.value === Q;
                    if (h || 1 < (s = p.value.split(X)).length) {
                      var f = p.name;
                      if (a.indexOf(f) < 0) {
                        a.push(f);
                        var m = r
                  ...
                  for (
                    ...
                    var v = l[d++];
                    (y && (v.value = ""), t.removeAttribute(v.name));
                  }
                  var w = t.nodeName;
                  if (/^script$/i.test(w)) {
                    var k = e.createElement(w);
        ...
        function ke(e, t) {
          var n = (
              e.convert ||
              function (e) {
                return e.join(X).replace(ue, fe).replace(ce, pe);
              }
            )(t),
            r = e.transform;
          r && (n = r(n));
                    ...
                    for (var s = 1, i = 1; s < e; ) {
                      ...
                      if (a.sparse) {
                        var l = a.values,
                          ...
                          u = 1,
                          d = l.length;
                        for (i += d - 2; u < d; ) c += arguments[s++] + l[u++];
                        a.fn(c);
        ...
        var Ae,
          ...
          Te =
            ((Ae = [].slice),
            ((Re = Ne.prototype).ELEMENT_NODE = 1),
            (Re.nodeType = 111),
          ...
          (t(e.placeholder),
            "text" in e
              ...
              : "any" in e
                ...
                : "html" in e
                  ? Promise.resolve(e.html).then(Pe).then(t)
                  : Promise.resolve(O.invoke(e, t)).then(t));
        }
        function Ie(e) {
                    ...
                    function a(e, t, n, r) {
                      for (
                        ...
                        (function e(t, n, r, o, s) {
                          ...
                          for (
                            var i = t.children || [], a = i.length, l = 0;
                            l < a;
                            e(i[l++], n, r, o, s)
                          );
                        })(o, s, t, n, r)
        ...
        var Ke = !(Ze.prototype = {
            attribute: function (e, t, n) {
              ...
              if (t in O.attributes)
                return function (n) {
                  var o = O.attributes[t](e, n);
                  r !== o &&
                    (null == (r = o)
                      ? e.removeAttribute(t)
                      : e.setAttribute(t, o));
                    ...
                    if (((s = !1), j((n = a))))
                      if (0 === a.length)
                        ...
                        switch (typeof a[0]) {
                          ...
                          case "object":
                            if (
                              (j(a[0]) && (a = a.concat.apply([], a)), Ie(a[0]))
                            ) {
            ...
            for: {
              ...
              value: function (e, t) {
                return (function (e, t, r, o) {
                  ...
                  this,
                  it.get(e) || ((r = e), (o = new v()), it.set(r, o), o),
                  e,
                  null == t ? "default" : t
                );
                var r, o;
    ...
    const {
            ...
            for (let e = 0; e < a.length; e++) {
              ...
              switch (i) {
                ...
                case "subtype":
                  ...
                  break;
                case "param-start":
                  if (O.test(l) || ";" === l) continue;
                  ((r += l), (i = "param-name"));
                  break;
                case "param-name":
                  if ("=" === l || ";" === l) {
                    if ("=" === l) {
                      ((i = "param-value"), (o = null));
                      continue;
                    }
                    (s.set(r.toLowerCase(), null), (r = ""));
                    continue;
                  }
                  r += l;
                  break;
      ...
      yt = it,
      vt = /-/g,
      wt = RegExp.escape ?? (e => e.replace(/[\\^$.*+?()[\]{}|]/g, "\\$&")),
    ...
    function jt(e) {
      const t = new Set(),
        n = "ltNodefault" in e.dataset ? "" : At(e.textContent),
        r = e.children[0];
      if (
        (e.dataset.lt
          ? e.dataset.lt
        ...
        e.dataset.localLt.split("|").forEach(e => t.add(At(e)));
      }
      return [...t];
    }
    function It(e, t, n = { copyAttributes: !0 }) {
            ...
            n.elements.forEach(t =>
              (function (e, t, n) {
                (e.classList.add("respec-offending-element"),
                  ...
                  e.id || Ot(e, "respec-offender"));
              })(t, e, n.title)
            ));
      }
      toJSON() {
        const { message: e, name: t, stack: n } = this,
          { plugin: r, hint: o, elements: s, title: i, details: a } = this;
        return {
          message: e,
          name: t,
          plugin: r,
    ...
    function Gt(e, t, n = {}) {
      ...
      tn("error", new Wt(e, t, r));
    }
    function Vt(e, t, n = {}) {
      const r = { ...n, isWarning: !0 };
      tn("warn", new Wt(e, t, r));
    }
    function Zt(e) {
      return {
        amendConfiguration: e => tn("amend-user-config", e),
        showError: (t, n) => Gt(t, e, n),
        showWarning: (t, n) => Vt(t, e, n),
      };
    }
    function Kt(e) {
      return e ? `\`${e}\`` : "";
    ...
    function Qt(e, { quotes: t } = { quotes: !1 }) {
      return Ct(e, t ? e => Kt(Jt(e)) : Kt).join("");
    }
    function Jt(e) {
      return String(e) ? `"${e}"` : "";
    }
      ...
      return Yt(
        e
          .map((e, n) => {
            ...
            const [o, s] = r.slice(1, -1).split("|");
            if (s) {
              return `${e}[${o}](${new URL(s, "https://respec.org/docs/")})`;
            }
    ...
    const en = new EventTarget();
    function tn(e, t) {
      if (
        (en.dispatchEvent(new CustomEvent(e, { detail: t })),
      ...
      en.addEventListener(
        ...
        async n => {
          try {
            ...
            const n = t;
            Gt(`Error in handler for topic "${e}": ${n.message}`, `sub:${e}`, {
              cause: n,
            });
          }
        },
    ...
    n("core/pubsubhub", { sub: nn });
    const rn = ["githubToken", "githubUser"];
    const on = new Map([
      ["text/html", "html"],
      ["application/xml", "xml"],
    ]);
    ...
    function an(e, t) {
      ...
      !(function (e) {
        ...
        const o = e.createDocumentFragment(),
          s = e.querySelector("meta[name='viewport']");
        s && t.firstChild !== s && o.appendChild(s);
        const i =
  ...
  `;
        (o.appendChild(l), t.prepend(o), tn("beforesave", r));
      })(n);
      let r = "";
    ...
    n("core/exporter", { rsDocToDataURL: sn });
    class ln {
      constructor() {
    ...
    const cn = "core/post-process";
    const un = "core/pre-process";
    const dn = "core/base-runner";
    async function pn(e) {
      (!(function () {
        const e = new ln();
        Object.defineProperty(document, "respec", { value: e });
      })(),
        tn("start-all", respecConfig),
        (function (e) {
          const t = {},
            n = e => Object.assign(t, e);
          (n(e),
            nn("amend-user-config", n),
            nn("end-all", () => {
              const e = document.createElement("script");
              ((e.id = "initialUserConfig"), (e.type = "application/json"));
              for (const e of rn) e in t && delete t[e];
        ...
        (function (e) {
          ...
          (Object.assign(e, r), tn("amend-user-config", r));
        })(respecConfig),
        performance.mark(`${dn}-start`),
        await (async function (e) {
          if (Array.isArray(e.preProcess)) {
            const t = e.preProcess.filter(e => {
              ...
              return (
                t ||
                  Gt("Every item in `preProcess` must be a JS function.", un),
                t
              );
            });
            for (const [n, r] of t.entries()) {
              ...
              try {
                ...
                Gt(`Function ${t} threw an error during \`preProcess\`.`, un, {
      ...
      (t.forEach(e => !e.name && console.warn("Plugin lacks name:", e)),
        ...
        await (async function (e) {
          if (Array.isArray(e.postProcess)) {
            const t = e.postProcess.filter(e => {
              ...
              return (
                t ||
                  Gt("Every item in `postProcess` must be a JS function.", cn),
                t
              );
            });
            for (const [n, r] of t.entries()) {
              ...
              try {
                ...
                Gt(`Function ${t} threw an error during \`postProcess\`.`, cn, {
                  hint: "See developer console.",
                  cause: e,
                });
              }
        ...
        tn("end-all", void 0),
        _t(document),
        performance.mark(`${dn}-end`),
        performance.measure(dn, `${dn}-start`, `${dn}-end`));
    }
    var hn = String.raw`.respec-modal .close-button{position:absolute;z-index:inherit;padding:.2em;font-weight:700;cursor:pointer;margin-left:5px;border:none;background:0 0}
...
.respec-plugin{text-align:right;color:rgb(120,120,120,.5);font-size:.6em}`;
    const fn = /&gt;/gm,
      mn = /&amp;/gm;
    class gn extends gt.Renderer {
      code(e) {
        const { text: t, lang: n = "" } = e,
          { language: r, ...o } = gn.parseInfoString(n);
        ...
        if (!i && !a) return s;
        const l = i || a,
          c = `${r} ${i ? "example" : "illegal-example"}`;
        return s.replace("<pre>", `<pre title="${l}" class="${c}">`);
      }
      image(e) {
    ...
    const bn = { gfm: !0, renderer: new gn() };
    function yn(e, t = { inline: !1 }) {
      const n = (function (e) {
          if (!e) return e;
          const t = e.trimEnd().split("\n"),
          ...
          const s = " ".repeat(o);
          return r.map(e => (e.startsWith(s) ? e.slice(o) : e)).join("\n");
        })(e),
        r = n.replace(fn, ">").replace(mn, "&");
      return t.inline ? gt.parseInline(r, bn) : gt.parse(r, bn);
    }
    function vn(e) {
    ...
    const wn =
      ((kn = "[data-format='markdown']:not(body)"),
      e => {
        const t = e.querySelectorAll(kn);
    ...
    var xn = Object.freeze({
      ...
      run: function (e) {
        const t = !!document.querySelector("[data-format=markdown]:not(body)"),
          n = "markdown" === e.format;
        if (!n && !t) return;
        if (!n) return void wn(document.body);
    ...
    const _n = ft`<div id="respec-ui" class="removeOnSave" hidden></div>`,
      Sn = ft`<ul
  id="respec-menu"
  role="menu"
...
>
  ❌
    ...
    let Cn, Ln;
    window.addEventListener("load", () => On(Sn));
    const An = [],
      Rn = [],
      Tn = {};
    (nn("start-all", () => document.body.prepend(_n), { once: !0 }),
      nn("end-all", () => document.body.prepend(_n), { once: !0 }));
    const Nn = ft`<button id="respec-pill" disabled>ReSpec</button>`;
    function Pn() {
      (Sn.classList.toggle("respec-hidden"),
        Sn.classList.toggle("respec-visible"),
        (Sn.hidden = !Sn.hidden));
    }
    function On(e) {
    ...
    (_n.appendChild(Nn),
      Nn.addEventListener("click", e => {
        (e.stopPropagation(),
          Nn.setAttribute("aria-expanded", String(Sn.hidden)),
          Pn(),
          Sn.querySelector("li:first-child button").focus());
      }),
  ...
  ></button>`;
      ...
      const s = 1 === t.length ? yt.singular(r) : r;
      $n(o, new Map([["label", `${t.length} ${s}`]]));
    }
    $n(Nn, jn);
    const zn = {
      show() {
      ...
      addCommand(e, t, n, r) {
        ...
        const o = `respec-button-${e.toLowerCase().replace(/\s+/, "-")}`,
          s = ft`<button id="${o}" class="respec-option">
      <span class="respec-cmd-icon" aria-hidden="true">${r}</span> ${e}…
    </button>`,
          i = ft`<li role="menuitem">${s}</li>`;
        return (i.addEventListener("click", t), Sn.appendChild(i), s);
      },
      error(e) {
        In(e, An, "error", "ReSpec Errors");
      },
      warning(e) {
        In(e, Rn, "warning", "ReSpec Warnings");
      },
      closeModal(e) {
        if (Ln) {
          const e = Ln;
        ...
        (e && e.setAttribute("aria-expanded", "false"),
          Cn && (Cn.remove(), (Cn = null), Nn.focus()));
      },
      freshModal(e, t, n) {
        (Cn && Cn.remove(),
          Ln && Ln.remove(),
          (Ln = ft`<div id="respec-overlay" class="removeOnSave"></div>`));
        const r = `${n.id}-modal`,
          o = `${r}-heading`;
        Cn = ft`<div
      id="${r}"
    ...
    >
      ...
      <div class="inside">${t}</div>
        ...
        ($n(Cn, s),
          document.body.append(Ln, Cn),
          Ln.addEventListener("click", () => this.closeModal(n)),
          Ln.classList.toggle("respec-show-overlay"),
          (Cn.hidden = !1),
          On(Cn));
      },
    };
    function Dn(e) {
      ...
      const t = e.plugin
          ...
          : "",
        n = e.hint
          ? `\n${yn(`<p class="respec-hint"><strong>How to fix:</strong> ${Yt(e.hint)}`, { inline: !e.hint.includes("\n") })}\n`
          : "",
        r = Array.isArray(e.elements)
          ? `<p class="respec-occurrences">Occurred <strong>${e.elements.length}</strong> times at:</p>\n    ${yn(e.elements.map(Mn).join("\n"))}`
          : "",
        o = e.details ? `\n\n<details>\n${e.details}\n</details>\n` : "";
      var s;
      return `${yn(`**${((s = e.message), s.replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/</g, "&lt;"))}**`, { inline: !0 })}${n}${r}${o}${t}`;
    }
    function Mn(e) {
    ...
    (document.addEventListener("keydown", e => {
      ...
      (window.respecUI = zn),
      nn("error", e => zn.error(e)),
      nn("warn", e => zn.warning(e)),
    ...
    var Gn = Object.freeze({
      ...
      run: function (e) {
        const t = !1 !== e.lint && { ...Fn.lint, ...Wn.lint, ...e.lint };
        (Object.assign(e, { ...Fn, ...Wn, ...e, lint: t }),
          Object.assign(
            e,
            (function (e) {
              return {
                isCCBY: "cc-by" === e.license,
                licenseInfo: Un.get(e.license),
    ...
    var Vn = String.raw`@keyframes pop{
...
body:has(input[name=color-scheme][value=dark]:checked){color-scheme:dark}`;
    ...
    var Kn = Object.freeze({
      ...
      name: "core/style",
      run: function (e) {
        e.noReSpecCSS && Zn.remove();
      },
    });
    const Qn = "geonovum/style";
    function Jn(e) {
    ...
    const Xn = (function () {
        ...
        for (const n of e.map($t)) t.appendChild(n);
        return t;
      })(),
      Yn = document.createElement("link");
    ((Yn.rel = "shortcut icon"),
      (Yn.type = "image/x-icon"),
      (Yn.href =
        "https://tools.geostandaarden.nl/respec/style/logos/Geonovum.ico"),
      document.head.prepend(Yn),
    ...
    var er = Object.freeze({
      ...
      run: function (e) {
        if (!e.specStatus) {
          ...
          ((e.specStatus = "GN-BASIS"), Vt(t, Qn));
        }
        document.body.querySelector("figure.scalable") &&
          (document.head.appendChild(Jn("leaflet")),
          document.head.appendChild(Jn("font-awesome")));
        let t = "";
    ...
    const tr = {
      en: {
        status_at_publication: ft`This section describes the status of this
      ...
      nl: {
        status_at_publication: ft`Deze paragraaf beschrijft de status van dit
    ...
    Object.keys(tr).forEach(e => {
      (o[e] || (o[e] = {}), Object.assign(o[e], tr[e]));
    });
    var nr = Object.freeze({ __proto__: null, name: "geonovum/l10n" });
    const rr = "core/github";
    let or, sr;
    const ir = new Promise((e, t) => {
        ((or = e),
          (sr = e => {
            (Gt(e, rr), t(new Error(e)));
          }));
      }),
      ar = Rt({
        en: {
    ...
    var lr = Object.freeze({
      ...
      run: async function (e) {
        if (!e.hasOwnProperty("github") || !e.github) return void or(null);
        if (
          "object" == typeof e.github &&
          !e.github.hasOwnProperty("repoURL")
        ) {
          const e = Xt`Config option ${"[github]"} is missing property \`repoURL\`.`;
          return void sr(e);
        }
        ...
        try {
          ...
          const e = Xt`${"[github]"} configuration option is not a valid URL? (${r}).`;
          return void sr(e);
        }
        if ("https://github.com" !== n.origin) {
          const e = Xt`${"[github]"} configuration option must be HTTPS and pointing to GitHub. (${n.href}).`;
          return void sr(e);
        }
        const [o, s] = n.pathname.split("/").filter(e => e);
        if (!o || !s) {
          const e = Xt`${"[github]"} URL needs a path. For example, "w3c/my-spec".`;
          return void sr(e);
        }
        const i = t.branch || "gh-pages",
          a = new URL("./issues/", n).href,
          l = new URL("./new/choose", a).href;
        let c, u;
        if (
          ((c =
          ...
          try {
            ...
            if ("https://github.com" !== e.origin) {
              const e = Xt`${"[github.pullsURL]"} must be HTTPS and pointing to GitHub. (${c}).`;
              return void sr(e);
            }
            if (!e.pathname.includes("/pulls")) {
              const e = Xt`${"[github.pullsURL]"} must point to pull requests. (${c}).`;
              return void sr(e);
            }
          } catch {
            const e = Xt`${"[github.pullsURL]"} is not a valid URL. (${c}).`;
            return void sr(e);
          }
        if (
          ((u =
          ...
          try {
            const e = new URL(u);
            if ("https://github.com" !== e.origin) {
              const e = Xt`${"[github.commitHistoryURL]"} must be HTTPS and pointing to GitHub. (${u}).`;
              return void sr(e);
            }
            if (!e.pathname.includes("/commits")) {
              const e = Xt`${"[github.commitHistoryURL]"} must point to commits. (${u}).`;
              return void sr(e);
            }
          } catch {
            const e = Xt`${"[github.commitHistoryURL]"} is not a valid URL. (${u}).`;
            return void sr(e);
          }
        const d = {
          edDraftURI: `https://${o.toLowerCase()}.github.io/${s}/`,
          githubToken: void 0,
          githubUser: void 0,
          issueBase: a,
          atRiskBase: a,
        ...
        if (!e.excludeGithubLinks) {
          const t = {
            key: ar.participate,
            data: [
              { value: `GitHub ${o}/${s}`, href: n },
              { value: "All issues", href: a },
              { value: ar.file_a_bug, href: l },
              { value: ar.commit_history, href: u },
    ...
    class cr {
      ...
      processHeader(e, t) {
        cr.sectionClasses.intersection(new Set(e.classList)).forEach(e => {
          t.classList.add(e);
        });
      }
      addSection(e) {
    ...
    function ur(e) {
      const t = new cr(e.ownerDocument);
      for (; e.firstChild; ) {
    ...
    const hr = "core/data-include";
    function fr(e, t, n) {
      const r = document.querySelector(`[data-include-id=${t}]`);
      if (!r) return;
      const o = Tt(e, r.dataset.oninclude, n),
      ...
      const n = e.querySelectorAll("[data-include]"),
        r = Array.from(n).map(async e => {
          ...
          try {
            ...
            (fr(await o.text(), r, n), t < 3 && (await mr(e, t + 1)));
          } catch (t) {
            const r = t;
            Gt(`\`data-include\` failed: \`${n}\` (${r.message}).`, hr, {
              elements: [e],
              cause: r,
            });
          }
    ...
    var yr = Object.freeze({
      ...
      run: function () {
        document.querySelectorAll("[data-transform]").forEach(e => {
          ((e.innerHTML = Tt(e.innerHTML, e.dataset.transform)),
            e.removeAttribute("data-transform"));
        });
      },
    });
    var vr = String.raw`:root{--assertion-border:#aaa;--assertion-bg:#eee;--assertion-text:black}
...
:root{--assertion-border:#444;--assertion-bg:var(--borderedblock-bg);--assertion-text:var(--text)}
    ...
    var wr = Object.freeze({
      ...
      run: function () {
        ...
        ((t.textContent = vr), document.head.appendChild(t));
      },
    });
    const kr = /^[a-z]+(\s+[a-z]+)+\??$/,
      xr = /\B"([^"]*)"\B/,
  ...
  >`;
      ...
      try {
        t = (function (e) {
          ...
          for (; s.length; ) {
            const t = s.pop() ?? "";
            if ($r.test(t)) {
              const [, e, n, r, o] = t.match($r),
                s = (n ?? "").split(/,\s*/).filter(e => e),
                l = r?.trim(),
        ...
        return (Gt(t.message, "core/inlines", { title: r, elements: [n] }), n);
      }
    ...
    const qr = new Set(["alias", "reference"]),
      Hr = (async function () {
    ...
    const Br = {
        ...
        async has(e, t) {
          if (!qr.has(e)) throw new TypeError(`Invalid type: ${e}`);
        ...
        async addAll(e, t) {
          ...
          const r = [...qr].flatMap(e => n[e].map(t => this.add(e, t)));
          await Promise.all(r);
        },
        async add(e, t) {
          if (!qr.has(e)) throw new TypeError(`Invalid type: ${e}`);
      ...
      Fr = {},
      Ur = new URL("https://api.specref.org/bibrefs?refs="),
      Wr = $t({ hint: "dns-prefetch", href: Ur.origin });
    let Gr;
    document.head.appendChild(Wr);
    const Vr = new Promise(e => {
      Gr = e;
    });
    async function Zr(e, t = { forceUpdate: !1 }) {
      const n = [...new Set(e)].filter(e => e.trim());
      if (!n.length || !1 === navigator.onLine) return null;
      let r;
      try {
        r = await fetch(Ur.href + n.join(","));
      } catch (e) {
      ...
      try {
        const e = Date.parse(r.headers.get("Expires") || ""),
          t = Number.isNaN(e) ? s : Math.min(e, s);
        await Br.addAll(o, t);
      } catch (e) {
        console.error(e);
      }
    ...
    async function Kr(e) {
      ...
      const n = t[e];
      return n.aliasOf ? await Kr(n.aliasOf) : n;
    }
    var Qr = Object.freeze({
      ...
      Plugin: class {
        ...
        async run() {
          ...
          (r.forEach(e => {
            ...
            o.hasData.forEach(e => {
              e.data && (Fr[e.id] = e.data);
            }));
          const s = o.noData.map(e => e.id);
          if (s.length) {
            const e = await Zr(s, { forceUpdate: !0 });
            Object.assign(Fr, e);
          }
          (Object.assign(Fr, this.conf.localBiblio),
            (() => {
              Gr(this.conf.biblio);
            })());
        }
      ...
      name: "core/biblio",
      resolveRef: Kr,
      updateFromNetwork: Zr,
    });
    const Jr = "core/render-biblio";
    function Xr(e) {
      return `bib-${Pt(e)}`;
    }
    const Yr = Rt({
      ...
      return (
        ...
        (function (e) {
          for (const { ref: t } of e) {
            const e = [
              ...document.querySelectorAll(`a.bibref[href="#${Xr(t)}"]`),
            ].filter(
              ({ textContent: e }) => e.toLowerCase() === t.toLowerCase()
            );
            Gt(`Reference "[${t}]" not found.`, Jr, {
    ...
    function oo(e) {
      ...
      for (; t && t.aliasOf; )
        ...
        } else ((n = t.aliasOf), (t = Fr[n]), r.add(n));
      return (
    ...
    function ao(e) {
      ...
      if (
        ...
        if (!Array.isArray(e.authors)) {
          ...
          (Gt(t, Jr, { hint: n }), (e.authors = [e.authors]));
        }
        e.authors.length &&
          ((t += e.authors.join("; ")),
          e.etAl && (t += " et al"),
      ...
      return (
        e.publisher && (t = `${t} ${to(e.publisher)} `),
        e.date && (t += `${e.date}. `),
        e.status && (t += `${eo.get(e.status) || e.status}. `),
      ...
      run: function (e) {
        ...
        if (
          (document.querySelector("section#references > :is(h2, h1)") ||
            r.prepend(ft`<h1>${Yr.references}</h1>`),
          r.classList.add("appendix"),
          n.length)
        ) {
          const e = ro(n, Yr.norm_references);
          r.appendChild(e);
        }
        if (t.length) {
          const e = ro(t, Yr.info_references);
          r.appendChild(e);
        }
        document.body.appendChild(r);
      },
    });
    const co = "core/inlines",
      uo = {},
      po = e => new RegExp(e.map(e => e.source).join("|")),
      ho = Rt({
        en: {
          rfc2119Keywords: () =>
            po([
  ...
  >`;
    ...
    function Co(e, t, n) {
      ...
      const [o, s] = r.split("|").map(At),
        { type: i, illegal: a } = zt(o, t.parentElement),
        l = so(o, s),
        c = o.replace(/^(!|\?)/, "");
    ...
    function Ro(e) {
      const t = (function (e) {
          const t = e => e.replace("%%", "/").split("/").map(At).join("/"),
            n = e.replace("\\/", "%%"),
            r = n.lastIndexOf("/");
          if (-1 === r) return [t(n)];
          const o = n.substring(0, r),
            s = n.substring(r + 1, n.length);
          return [t(o), t(s)];
        })((e = e.slice(2, -2))),
  ...
  >`;
    ...
    var Po = Object.freeze({
      ...
      run: function (e) {
        ...
        (document.normalize(),
          ...
          (e.normativeReferences = new qt()),
          (e.informativeReferences = new qt()),
          e.respecRFC2119 || (e.respecRFC2119 = uo));
        ...
        const r = t.size
            ? new RegExp(
                `(?:\\b${[...t.keys()].map(e => wt(e)).join("\\b)|(?:\\b")}\\b)`
              )
            : null,
          ...
          s = ho.rfc2119Keywords(),
          i = new RegExp(
            `(${po([s, mo, ko, go, bo, yo, vo, fo, wo, ...(r ? [r] : [])]).source})`
          );
        for (const n of o) {
    ...
    function Oo(e, t, n, r) {
      try {
        ...
        Gt(`Invalid ${t} name "${e}": ${o.message}`, r, {
    ...
    const Io = new Ut();
    function zo(e, t) {
      for (const n of t) (Io.has(n) || Io.set(n, new Set()), Io.get(n)?.add(e));
    }
    const Do = "core/dfn",
      Mo = new Map([
        ...
        ["element", { requiresFor: !1, validator: Oo }],
        ["element-attr", { requiresFor: !1, validator: Oo }],
        [
          "element-state",
          {
            requiresFor: !0,
        ...
        ["event", { requiresFor: !1, validator: jo }],
        ...
        ["scheme", { requiresFor: !1, validator: jo }],
        [
          "permission",
          {
            requiresFor: !1,
    ...
    function Ho(e, t) {
      let n = "";
      switch (!0) {
        case qo.some(t => e.classList.contains(t)):
          ((n = [...e.classList].find(e => Mo.has(e)) ?? ""),
            (function (e, t, n) {
              const r = Mo.get(t);
              if (r?.requiresFor && !n.dataset.dfnFor) {
                const e = Xt`Definition of type "\`${t}\`" requires a ${"[data-dfn-for]"} attribute.`,
                  { associateWith: o } = r,
                  s = Xt`Use a ${"[data-dfn-for]"} attribute to associate this with ${o ?? ""}.`;
                Gt(e, Do, { hint: s, elements: [n] });
              }
              r?.validator && r.validator(e, t, n, Do);
            })(t, n, e));
          break;
        case _r.test(t):
          n = (function (e, t) {
            ...
            if (!t.dataset.dfnFor) {
              const n = Xt`Use a ${"[data-dfn-for]"} attribute to associate this dfn with a WebIDL interface.`;
              Gt(
            ...
            const o = ["attribute", "method"],
              { dfnType: s } = t.dataset;
            if (!o.includes(s) || r !== s) {
              const n = Xt`Invalid ${"[data-dfn-type]"} attribute on internal slot.`,
                s = `The only allowed types are: ${Qt(o, { quotes: !0 })}. The slot "${e}" seems to be a "${Kt(r)}"?`;
              return (Gt(n, Do, { hint: s, elements: [t] }), "dfn");
            }
            return s;
          })(t, e);
      }
    ...
    function Bo(e) {
      switch (!0) {
        case e.matches(".export.no-export"):
          Gt(
            Xt`Declares both "${"[no-export]"}" and "${"[export]"}" CSS class.`,
            Do,
        ...
        case e.matches(".no-export, [data-noexport]"):
          if (e.matches("[data-export]")) {
            (Gt(
              Xt`Declares ${"[no-export]"} CSS class, but also has a "${"[data-export]"}" attribute.`,
              Do,
    ...
    var Fo = Object.freeze({
      ...
      run: function () {
        for (const e of document.querySelectorAll("dfn")) {
          const t = jt(e);
          if ((zo(e, t), e.dataset.cite && /\b#\b/.test(e.dataset.cite)))
            continue;
          const [n] = t;
          (Ho(e, n), Bo(e));
          const r = (e.dataset.localLt || "").split("|").map(At),
            o = t.filter(e => !r.includes(e));
          (o.length > 1 || n !== At(e.textContent)) &&
            (e.dataset.lt = o.join("|"));
        }
      },
    });
      ...
      run: function (e) {
        ...
        const t = (function () {
          ...
          document.querySelectorAll("a:not([href])").forEach(t => {
            const n = At(t.textContent).toLowerCase();
          ...
          return (
            n.forEach(e => {
              const n = At(e.textContent).toLowerCase();
              (t.add(n),
          ...
          .forEach(e => {
            ...
            if (r.size) {
              const t = e.dataset.plurals ? e.dataset.plurals.split("|") : [],
                n = [...new Set([...t, ...r])];
              ((e.dataset.plurals = n.join("|")), zo(e, n));
            }
          });
      },
    });
    var Wo = String.raw`span.example-title{text-transform:none}
...
aside.example div.example{border-left-width:.1em;border-color:#999;background:#fff}`;
    ...
    <a class="self-link">${Go.example}<bdi>${r}</bdi></a
    >${o}
  </div>`;
    }
      ...
      ${Wo}
        ...
        e.forEach(e => {
          ...
          if ("aside" === e.localName) {
            ...
            const o = Vo(e, t, n);
            e.prepend(o);
            const s = Ot(e, "example", r || String(t));
            o.querySelector("a.self-link").href = `#${s}`;
          } else {
            const o = !!e.closest("aside");
            (o || ++t,
              (n.content = e.innerHTML),
              e.classList.remove("example", "illegal-example"));
            const s = e.id ? e.id : null;
            s && e.removeAttribute("id");
            const i = Vo(e, o ? 0 : t, n),
              a = ft`<div class="example" id="${s}">
        ${i} ${e.cloneNode(!0)}
      </div>`;
            Ot(a, "example", r || String(t));
    ...
    var Ko = String.raw`.issue-label{text-transform:initial}
...
.issue a.respec-gh-label{padding:5px;margin:0 2px 0 2px;font-size:10px;text-transform:none;text-decoration:none;font-weight:700;border-radius:4px;position:relative;bottom:2px;border:none;display:inline-block}`;
    ...
    function Xo(e, t, n) {
      ...
      (e.forEach(e => {
        ...
        if (!c) {
          const r = ft`<div class="${a ? `${s} atrisk` : s}" role="${"note" === s ? "note" : null}"></div>`,
            c = document.createElement("span"),
            p = ft`<div class="${`${s}-title marker`}">${c}</div>`;
          Ot(p, "h", s);
          let h,
            f = i;
          if (
            (e.id
              ...
              : Ot(r, "issue-container", d.number ? `number-${d.number}` : ""),
            l)
          ) {
            if (
              ...
              if (
                ...
                Vt(`Failed to fetch issue number ${u}.`, Qo);
              }
                    ...
                    (function (e, t) {
                      ...
                      const s = (function (e) {
                          const [t, n, r] = [
                            ...
                            a = 0.2126 * o + 0.7152 * s + 0.0722 * i;
                          return a > 0.179 ? "#000" : "#fff";
                        })(n),
                        i = `background-color: #${n}; color: ${s}`,
                        a = `GitHub label: ${r}`;
                      return ft` <a
  ...
  >`;
        ...
        (function (e) {
          ...
          (e.hasChildNodes()
            ? t.append(e)
            : t.append(ft`<p>${Jo.no_issues_in_spec}</p>`),
            (!n || (n && n !== t.firstElementChild)) &&
              t.insertAdjacentHTML(
                "afterbegin",
                `<h1>${Jo.issue_summary}</h1>`
              ));
        })(o));
    }
              ...
              document.querySelectorAll("figure").forEach((t, n) => {
                ...
                if (r)
                  (!(function (e, t, n) {
                    ...
                    (Ot(e, "fig", r),
                      Dt(t, ft`<span class="fig-title"></span>`),
                      t.prepend(
                        ft`<a class="self-link" href="#${e.id}"
      >${is.fig}<bdi class="figno">${n + 1}</bdi></a
    >`,
                        " "
                      ));
                  })(t, r, n),
                      ...
                      (function (e, t) {
                        ...
                        return (
                          n.querySelectorAll("a").forEach(e => {
                            It(e, "span").removeAttribute("href");
                          }),
                          ft`<li class="tofline">
    <a class="tocxref" href="${`#${e}`}">${n.childNodes}</a>
                  ...
                  Vt("Found a `<figure>` without a `<figcaption>`.", ss, {
                    elements: [t],
                  });
                }
              }),
    ...
    const ls = "core/data-cite",
      cs = "__SPEC__";
    async function us(e) {
      const { key: t, frag: n, path: r, href: o } = e;
      let s = "",
        i = "";
      if (t === cs) s = document.location.href;
      else {
        const e = await Kr(t);
        if (!e) return null;
        ((s = e.href ?? ""), (i = e.title));
      ...
      if (o) s = o;
        ...
        n && (s = new URL(n, s).href);
      }
      return { href: s, title: i };
    }
    function ds(e, t, n) {
      ...
      switch (e.localName) {
        ...
        case "dfn": {
          ...
          if (
            ...
            e.textContent ? Dt(e, t) : ((t.textContent = o), e.append(t)),
            s)
          ) {
          ...
          if ("export" in e.dataset) {
            (Gt("Exporting a linked external definition is not allowed.", ls, {
    ...
    function ms(e) {
      const { dataset: t } = e,
        { cite: n, citeFrag: r, citePath: o, citeHref: s } = t;
      if ((n ?? "").startsWith("#") && !r) {
        const r =
            e.parentElement?.closest('[data-cite]:not([data-cite^="#"])') ??
            null,
          { key: o, isNormative: s } = r ? ms(r) : { key: cs, isNormative: !1 };
        return (
          (t.cite = s ? o : `?${o}`),
    ...
    var bs = Object.freeze({
      ...
      run: async function () {
        ...
        await (async function (e) {
          const t = e
              .map(ms)
              .map(async e => ({ entry: e, result: await Kr(e.key) })),
            n = (await Promise.all(t))
              .filter(({ result: e }) => null === e)
              .map(({ entry: { key: e } }) => e),
            r = await Zr(n);
          r && Object.assign(Fr, r);
        })([...e]);
        for (const t of e) {
    ...
    function ks(e) {
      const t = new Map(),
        n = [];
      for (const r of Io.get(e) ?? []) {
        const { dfnType: o = "dfn" } = r.dataset,
          s = r.dataset.dfnFor?.split(",").map(e => e.trim()) ?? [""];
        for (const i of s) {
          if (t.has(i) && t.get(i)?.has(o)) {
            const e = t.get(i)?.get(o),
              s = "dfn" === e?.localName,
              a = "dfn" === r.localName,
          ...
          (t.has(i) || t.set(i, new Map()),
            t.get(i)?.set(o, r),
            ("idl" in r.dataset || "dfn" !== o) && t.get(i)?.set("idl", r),
            Ot(r, "dfn", e));
        }
      }
    ...
    function xs(e, t) {
      ...
      if (o) {
        for (const e of o.split("|")) if (r?.get(e)) return r.get(e);
        return r?.get("dfn");
      }
      {
        ...
        (function (e) {
          ...
          (function (e, t) {
            const n = e.textContent.trim(),
              ...
              o = _s(e) && _s(t, n);
            (r && !o) || Dt(e, document.createElement("code"));
          })(e, t),
        !r
      );
    }
    ...
    function Ss(e) {
      e.forEach(e => {
        const t = `Found linkless \`<a>\` element with text "${e.textContent}" but no matching \`<dfn>\``,
          ...
          r = `Add a matching \`<dfn>\` element, ${Xt`use ${"[data-cite]"} to link to an external definition, or enable ${"[xref]"} for automatic cross-spec linking.`}${n ? ` This link is inside a \`data-link-for="${n.dataset.linkFor}"\` section — \`[=term=]\` links are scoped to that context. To link to a global concept instead, either add \`data-link-for=""\` on this \`<a>\` or move it outside the scoped section.` : ""}`;
        Vt(t, ys, {
    ...
    var Es = Object.freeze({
      __proto__: null,
      name: ys,
      possibleExternalLinks: vs,
      run: async function (e) {
        const t = (function () {
            const e = new Ut();
            for (const t of Io.keys()) {
              const { result: n, duplicates: r } = ks(t);
              (e.set(t, n),
                r.length > 0 &&
                  Gt(ws.duplicateMsg(t), ys, {
                    title: ws.duplicateTitle,
                    elements: r,
                  }));
            }
            return e;
        ...
        for (const e of r) {
          ...
          if (r) {
            $s(e, r, t) || vs.push(e);
          } else "" === e.dataset.cite ? n.push(e) : vs.push(e);
        }
        (Ss(n),
          (function (e) {
            const { shortName: t = "" } = e,
              n = new RegExp(String.raw`^([?!])?${wt(t)}\b([^-])`, "i"),
              r = document.querySelectorAll(
                "dfn[data-cite]:not([data-cite='']), a[data-cite]:not([data-cite=''])"
              );
            for (const t of r) {
              t.dataset.cite = (t.dataset.cite ?? "").replace(n, `$1${cs}$2`);
              const { key: r, isNormative: o } = ms(t);
              r !== cs &&
    ...
    var Ls = Object.freeze({
      ...
      run: async function (e) {
        ...
        if (!e.github) {
          return void Gt(
            Xt`Requested list of contributors from GitHub, but ${"[github]"} configuration option is not set.`,
            Cs
          );
        }
        ...
        await (async function (e, t) {
          ...
          async function o() {
            ...
            try {
                ...
                if ("caches" in window)
                  try {
                    if (
                      ...
                      (s = await o.match(n)),
                      s &&
                        new Date(s.headers.get("Expires") ?? "") > new Date())
                    )
                      return s;
                  } catch (e) {
              ...
              return (
                Gt("Error loading contributors from GitHub.", Cs, { cause: e }),
                null
              );
            }
          }
    ...
    function js(e) {
      ...
      for (const e of t) {
        ...
        if (!Rs.includes(r.localName)) continue;
    ...
    var zs = Object.freeze({
      ...
      run: function (e) {
        if (
          ...
          const t = Ps(js(document.body), e.maxTocLevel);
          t &&
            (function (e) {
              if (!e) return;
              const t = ft`<nav id="toc"></nav>`,
                n = ft`<h2 class="introductory">${Ns.toc}</h2>`;
              (Ot(n), t.append(n, e));
              const r =
    ...
    <a href="#title"><abbr title="${Ns.back_to_top}">&uarr;</abbr></a>
  </p>`;
    ...
    var Ms = Object.freeze({
      ...
      run: function () {
        Array.from(document.querySelectorAll("section.informative"))
          ...
          .filter(e => null !== e)
          .forEach(e => {
            e.after(ft`<p><em>${Ds.informative}</em></p>`);
          });
      },
    });
    const qs = Rt({
    ...
    var Hs = Object.freeze({
      ...
      run: function (e) {
        ...
        for (const n of t) {
          let t = n.id;
          if (
            (t || (Ot(n), (t = n.parentElement?.id || n.id)),
            !e.addSectionLinks)
          )
            continue;
          const r = qs.permalinkLabel(
  ...
  `;
    ...
    function Gs(e, t) {
      const { id: n, href: r, ext: o, title: s, type: i } = e,
        a = (function (e, t = "") {
          return kt.format(e).replace(vt, t);
  ...
  >`;
    ...
    var Vs = Object.freeze({
      ...
      run: function (e) {
        ...
        ${Ws.map(t => Gs(t, e))}
              ...
              zn.freshModal(Us.save_snapshot, n, t);
            },
          },
    ...
    const Zs = "https://respec.org/specref/",
      Ks = Rt({
  ...
  `;
          zn.freshModal(Ks.search_specref, e, Qs);
        },
        "Ctrl+Shift+Alt+space",
        "🔎"
      );
    var Js = Object.freeze({ __proto__: null });
    const Xs = Rt({
    ...
    const Ys = document.createElement("div"),
      ei = ft.bind(Ys),
      ti = zn.addCommand(
        `${Xs.about_respec} ${window.respecVersion}`,
        function () {
          const e = [];
...
`,
  ...
  `;
    ...
    var ri = Object.freeze({ __proto__: null });
    ...
    const si =
      "\n  --base: #282c34;\n  --mono-1: #abb2bf;\n  --mono-2: #818896;\n  --mono-3: #5c6370;\n  --hue-1: #56b6c2;\n  --hue-2: #61aeee;\n  --hue-3: #c678dd;\n  --hue-4: #98c379;\n  --hue-5: #e06c75;\n  --hue-5-2: #be5046;\n  --hue-6: #d19a66;\n  --hue-6-2: #e6c07b;\n";
    var ii = String.raw`.hljs,body:has(input[name=color-scheme][value=light]:checked) .hljs,head:not(:has(meta[name=color-scheme][content~=dark]))+body .hljs{--base:#fafafa;--mono-1:#383a42;--mono-2:#686b77;--mono-3:#717277;--hue-1:#0b76c5;--hue-2:#336ae3;--hue-3:#a626a4;--hue-4:#42803c;--hue-5:#ca4706;--hue-5-2:#c91243;--hue-6:#986801;--hue-6-2:#9a6a01}
@media (prefers-color-scheme:dark){
.hljs{${si}}
}
body:has(input[name=color-scheme][value=dark]:checked) .hljs{${si}}
...
.hljs-link{text-decoration:underline}`;
    ...
    const li = new URL(
      ...
      ci = $t({ hint: "preload", href: li, as: "script" });
    async function ui() {
      try {
        return (
        ...
        return ai("worker/respec-worker.js");
      }
    }
    async function di() {
      try {
    ...
    const pi = (async function () {
      const [e, t] = await Promise.all([ui(), di()]),
        n = new Blob(
          [
            null !== t
              ? `${t}\n`
    ...
    async function fi(e) {
      ...
      try {
        o = await (async function (e, t) {
          const n = { action: "highlight", code: e, id: hi(), languages: t },
            r = await pi;
          return (
            r.postMessage(n),
            new Promise((e, t) => {
      ...
      const { language: s, value: i } = o;
      switch (t.localName) {
        case "pre":
          (t.classList.remove(s),
            (t.innerHTML = `<code class="hljs${s ? ` ${s}` : ""}">${i}</code>`),
            t.classList.length || t.removeAttribute("class"));
          break;
        case "code":
          ((t.innerHTML = i), t.classList.add("hljs"), s && t.classList.add(s));
      }
    ...
    var mi = Object.freeze({
      ...
      run: async function (e) {
        ...
        if (!t.length) return;
        const n = t.filter(e => e.textContent.trim()).map(fi);
    ...
    const gi = Rt({
        en: {
          missing_test_suite_uri: Xt`Found tests in your spec, but missing ${"[testSuiteURI]"} in your ReSpec config.`,
          tests: "tests",
          test: "test",
        },
        ja: {
          missing_test_suite_uri: Xt`この仕様内にテストの項目を検出しましたが，ReSpec の設定に ${"[testSuiteURI]"} が見つかりません．`,
          tests: "テスト",
          test: "テスト",
        },
        de: {
          missing_test_suite_uri: Xt`Die Spezifikation enthält Tests, aber in der ReSpec-Konfiguration ist keine ${"[testSuiteURI]"} angegeben.`,
          tests: "Tests",
          test: "Test",
        },
        zh: {
          missing_test_suite_uri: Xt`本规范中包含测试，但在 ReSpec 配置中缺少 ${"[testSuiteURI]"}。`,
          tests: "测试",
          test: "测试",
        },
      }),
  ...
  `;
      ...
      return e
        .map(e => {
          try {
            ...
            Vt(Xt`Invalid URL in ${"[data-tests]"} attribute: ${e}.`, bi, {
              elements: [n],
            });
          }
        })
    ...
    function wi(e, t) {
      ...
      if (n.length) {
        const e = Xt`Duplicate tests found in the ${"[data-tests]"} attribute.`,
          r = Xt`To fix, remove duplicates from ${"[data-tests]"}: ${(function (
            e,
            { quotes: t } = { quotes: !1 }
          ) {
            return Lt(e, t ? e => Kt(Jt(e)) : Kt);
          })(n, { quotes: !0 })}.`;
        Vt(e, bi, { hint: r, elements: [t] });
      }
    }
    function ki(e) {
      const t = [...new Set(e)];
  ...
  `;
    ...
    var xi = Object.freeze({
      ...
      run: function (e) {
        ...
        if (t.length)
          ...
          else Gt(gi.missing_test_suite_uri, bi);
      },
    });
    const $i = "core/list-sorter";
    function _i(e) {
    ...
    var Ci = Object.freeze({
        ...
        for (const t of e) {
          ...
          switch (t.localName) {
            ...
            case "ul":
              ...
              break;
            default:
              Vt(`ReSpec can't sort ${t.localName} elements.`, $i, {
                elements: [t],
              });
          }
          if (e) {
      ...
      sortDefinitionTerms: Ei,
      sortListItems: Si,
    });
    var Li = String.raw`var:hover{text-decoration:underline;cursor:pointer}
...
var.respec-hl{background:0 0;color:#000;box-shadow:unset}
    ...
    var Ai = Object.freeze({
      ...
      run: async function (e) {
        ...
        const t = document.createElement("style");
        ((t.textContent = Li), document.head.appendChild(t));
        ...
        ((n.id = "respec-highlight-vars"),
          (n.textContent = await (async function () {
            try {
              ...
              return ai("./src/core/highlight-vars.runtime.js");
            }
          })()),
    ...
    function Ni(e, t, n) {
      ...
      const o = [...Ht(r.querySelector(".self-link")).childNodes].map(
        e => (e.classList?.remove("figno"), e)
      );
      (n.append(...o), n.classList.add("fig-ref"));
      const s = r.querySelector(".fig-title");
      !n.hasAttribute("title") && s && (n.title = At(s.textContent));
    }
    function Pi(e, t, n) {
      ...
      const s = r.querySelector(".table-title");
      !n.hasAttribute("title") && s && (n.title = At(s.textContent));
    }
    function Oi(e, t, n) {
    ...
    var Di = String.raw`dfn{cursor:pointer}
...
.dfn-panel.docked{position:fixed;left:.5em;top:unset;bottom:2em;margin:0 auto;max-width:calc(100vw - .75em * 2 - .5em - .2em * 2);max-height:30vh;overflow:auto}`;
    function Mi(e) {
      const { id: t } = e,
        ...
        s = e.getAttribute("aria-label") || At(e.textContent),
        i = ft`
    <div
      class="dfn-panel"
      id="${o}"
        ...
        t.forEach((t, r) => {
          ...
          const s =
            (function (e) {
              ...
              return n ? `§ ${At(n.textContent)}` : null;
            })(t) ?? "";
  ...
  `;
        ...
        ((r.id = "respec-dfn-panel"),
          (r.textContent = await (async function () {
            try {
              ...
              return ai("./src/core/dfn-panel.runtime.js");
            }
          })()),
    ...
    const Bi = "core/linter-rules/check-charset",
      Fi = Rt({
        en: {
    ...
    var Ui = Object.freeze({
      ...
      run: function (e) {
        ...
        (n.includes("utf-8") && 1 === t.length) ||
          Vt(Fi.msg, Bi, { hint: Fi.hint, elements: [...t] });
      },
    });
    const Wi = "no-dfn-in-abstract",
      Gi = `core/linter-rules/${Wi}`,
      Vi = Rt({
        en: {
          msg: e =>
            `Definition \`${e}\` is in an unnumbered section (e.g. abstract or SotD).`,
          get hint() {
            return Xt`Definitions in unnumbered sections (abstract, SotD) are semantically out of place and appear in the terms index without a section number. Move this definition to a numbered section such as "Terminology". See ${"[export|#data-export]"}.`;
          },
        },
      }),
      Zi = ["section#abstract", "section#sotd", "section.introductory"].join(
        ", "
      );
    var Ki = Object.freeze({
      ...
      run: function (e) {
        ...
        t.forEach(e => {
          const t = At(e.textContent);
          Vt(Vi.msg(t), Gi, { hint: Vi.hint, elements: [e] });
        });
      },
    });
    const Qi = "core/linter-rules/check-punctuation",
      Ji = [".", ":", "!", "?"],
      Xi = Ji.map(e => `"${e}"`).join(", "),
      Yi = Rt({
        en: {
          msg: "`p` elements should end with a punctuation mark.",
          hint: `Please make sure \`p\` elements end with one of: ${Xi}.`,
        },
        cs: {
          msg: "Elementy `p` by měly končit interpunkčním znaménkem.",
          hint: `Ujistěte se, že elementy \`p\` končí jedním z těchto znaků: ${Xi}.`,
        },
      });
    var ea = Object.freeze({
      ...
      run: function (e) {
        ...
        const t = new RegExp(`[${Ji.join("")}\\]]$|^ *$`, "m"),
          n = [
            ...document.querySelectorAll("p:not(#back-to-top,#w3c-state)"),
          ].filter(e => !t.test(e.textContent.trim()));
        n.length && Vt(Yi.msg, Qi, { hint: Yi.hint, elements: n });
      },
    });
    const ta = "core/linter-rules/local-refs-exist",
      na = Rt({
        en: {
    ...
    var oa = Object.freeze({
      ...
      run: function (e) {
        ...
        const t = [...document.querySelectorAll("a[href^='#']")].filter(ra);
        t.length && Vt(na.msg, ta, { hint: na.hint, elements: t });
      },
    });
    const sa = "core/linter-rules/no-headingless-sections",
      ia = Rt({
        en: {
    ...
    var aa = Object.freeze({
      ...
      run: function (e) {
        ...
        t.length && Vt(ia.msg, sa, { hint: ia.hint, elements: t });
      },
    });
    const la = "core/linter-rules/no-unused-vars",
      ca = Rt({
        en: {
    ...
    var ua = Object.freeze({
      ...
      run: function (e) {
        ...
        t.length && Vt(ca.msg, la, { hint: ca.hint, elements: t });
      },
    });
    const da = "core/linter-rules/privsec-section",
      pa = Rt({
        en: {
    ...
    var ha = Object.freeze({
      ...
      run: function (e) {
        ...
        e.lint?.["privsec-section"] &&
          ...
          Vt(pa.msg, da, { hint: pa.hint });
      },
    });
    const fa = "core/linter-rules/no-http-props",
      ma = Rt({
        en: {
          msg: Xt`Insecure URLs are not allowed in ${"[respecConfig]"}.`,
          hint: "Please change the following properties to 'https://': ",
        },
        zh: {
          msg: Xt`${"[respecConfig]"} 中不允许使用不安全的URL.`,
          hint: "请将以下属性更改为 https://：",
        },
        cs: {
          msg: Xt`V ${"[respecConfig]"} nejsou povoleny nezabezpečené URL adresy.`,
