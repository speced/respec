((window.respecVersion = "35.9.0"),
  (function () {
    ...
    const T = /^[!#$%&'*+-.^`|~\w]+$/,
      P = /[\u000A\u000D\u0009\u0020]/u,
      N = /^[\u0009\u{0020}-\{u0073}\u{0080}-\u{00FF}]+$/u;
    function j(e, t, n) {
      ((t && "" !== t && !e.has(t) && N.test(n)) || null === n) &&
      ...
      let n = "string" == typeof e ? e : e.source,
        r = {
          replace: (e, t) => {
            ...
            return ((o = o.replace(B.caret, "$1")), (n = n.replace(e, o)), r);
          },
    ...
    var M = (() => {
      ...
      he = D(pe, "u").replace(/punct/g, ie).getRegex(),
      fe = D(pe, "u").replace(/punct/g, ue).getRegex(),
      me =
      ...
      we = D(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/)
        ...
        .getRegex(),
      ke = D(X).replace("(?:--\x3e|$)", "--\x3e").getRegex(),
      xe = D(
      ...
      Ne = { normal: Le, gfm: Re, breaks: Te, pedantic: Ae },
      je = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
    ...
    function Oe(e, t) {
      if (t) {
        if (B.escapeTest.test(e)) return e.replace(B.escapeReplace, Ie);
      } else if (B.escapeTestNoEncode.test(e))
        return e.replace(B.escapeReplaceNoEncode, Ie);
      return e;
    }
    function ze(e) {
      try {
    ...
    var Be = class {
        ...
        code(e) {
          ...
          if (t) {
            ...
            return {
              ...
              text: this.options.pedantic ? e : De(e, "\n"),
            };
          }
        }
        fences(e) {
      ...
      He = class e {
        ...
        constructor(e) {
          ...
          let t = { other: B, block: Pe.normal, inline: Ne.normal };
          (this.options.pedantic
            ? ((t.block = Pe.pedantic), (t.inline = Ne.pedantic))
            : this.options.gfm &&
              ((t.block = Pe.gfm),
              this.options.breaks
                ? (t.inline = Ne.breaks)
      ...
      Fe = class {
        ...
        image({ href: e, title: t, text: n, tokens: r }) {
          ...
          let s = `<img src="${(e = o)}" alt="${n}"`;
          return (t && (s += ` title="${Oe(t)}"`), (s += ">"), s);
        }
        text(e) {
        ...
        use(...e) {
          ...
          return (
            e.forEach(e => {
              ...
              if (e.tokenizer) {
                let t = this.defaults.tokenizer || new Be(this.defaults);
              ...
              if (e.hooks) {
                let t = this.defaults.hooks || new Ge();
                for (let n in e.hooks) {
                  ...
                  let r = n,
                    o = e.hooks[r],
                    s = t[r];
                  Ge.passThroughHooks.has(n)
                    ? (t[r] = e => {
                        if (
                          this.defaults.async &&
                          Ge.passThroughHooksRespectAsync.has(n)
                        )
                          return (async () => {
    ...
    ((Ze.options = Ze.setOptions =
      ...
      (Ze.defaults = O),
      (Ze.use = function (...e) {
        return (Ve.use(...e), (Ze.defaults = Ve.defaults), z(Ze.defaults), Ze);
      }),
      (Ze.walkTokens = function (e, t) {
        return Ve.walkTokens(e, t);
      }),
      (Ze.parseInline = Ve.parseInline),
      (Ze.Parser = We),
      (Ze.parser = We.parse),
      (Ze.Renderer = Fe),
      (Ze.TextRenderer = Ue),
      ...
      tt = (function (e) {
        ...
        var D,
          ...
          Z =
            ...
            (B = "cloneNode"),
            (H = "createTextNode"),
            (U = (F = "importNode") in (D = e)),
            (W = D.createDocumentFragment())[M](D[H]("g")),
            W[M](D[H]("")),
            (U ? D[F](W, !0) : W[B](!0)).childNodes.length < 2
              ? function e(t, n) {
                  for (
                    var r = t[B](), o = t.childNodes || [], s = o.length, i = 0;
                    n && i < s;
                    i++
                  )
                    r[M](e(o[i], n));
            ...
            "text" in e
              ...
              : "any" in e
                ...
                : "html" in e
                  ...
                  : Promise.resolve(j.invoke(e, t)).then(t));
        }
        function Oe(e) {
              ...
              return (
                Me &&
                  ...
                  (function (e) {
                    ...
                    function a(e, t, n, r) {
                      for (
                        var o, s = new qe(t), i = e.length, a = 0;
                        a < i;
                        1 === (o = e[a++]).nodeType &&
                        (function e(t, n, r, o, s) {
                          Be.has(t) &&
        ...
        var Ke = !(Ze.prototype = {
            attribute: function (e, t, n) {
              ...
              if (t in j.attributes)
                return function (n) {
                  var o = j.attributes[t](e, n);
                  r !== o &&
                    (null == (r = o)
                      ? e.removeAttribute(t)
                      : e.setAttribute(t, o));
                    ...
                    if (((s = !1), I((n = a))))
                      if (0 === a.length)
                        ...
                        switch (typeof a[0]) {
                          ...
                          case "object":
                            if (
                              (I(a[0]) && (a = a.concat.apply([], a)), Oe(a[0]))
                            ) {
        ...
        function ot() {
          ...
          return (
            e && e.template === t[0]
              ...
              : function (e) {
                  var t = new Ze(He in this ? "svg" : "html");
    ...
    function Ct(e) {
      const t = new Set(),
        n = "ltNodefault" in e.dataset ? "" : xt(e.textContent),
        r = e.children[0];
      if (
        (e.dataset.lt
          ? e.dataset.lt
        ...
        e.dataset.localLt.split("|").forEach(e => t.add(xt(e)));
      }
      return [...t];
    }
    function Lt(e, t, n = { copyAttributes: !0 }) {
    ...
    function It(e) {
      ...
      for (const e of [...Ot(t)]) e.remove();
    }
    function* Ot(e) {
      for (; e.nextNode(); ) yield e.currentNode;
    }
    class zt extends Map {
      constructor(e = []) {
        return (
          super(),
          e.forEach(([e, t]) => {
    ...
    function Dt(e, t, n = {}) {
      ...
      Zt("error", new qt(e, t, r));
    }
    function Mt(e, t, n = {}) {
      const r = { ...n, isWarning: !0 };
      Zt("warn", new qt(e, t, r));
    }
    function Bt(e) {
      return {
        showError: (t, n) => Dt(t, e, n),
        showWarning: (t, n) => Mt(t, e, n),
      };
    }
    function Ht(e) {
      return e ? `\`${e}\`` : "";
    }
    function Ft(e, { quotes: t } = { quotes: !1 }) {
      return wt(e, t ? e => Ht(Ut(e)) : Ht).join("");
    }
    function Ut(e) {
      return String(e) ? `"${e}"` : "";
    }
    ...
    const Vt = new EventTarget();
    function Zt(e, t) {
      if (
        (Vt.dispatchEvent(new CustomEvent(e, { detail: t })),
      ...
      Vt.addEventListener(
        ...
        async n => {
          try {
            ...
            Dt(`Error in handler for topic "${e}": ${t.message}`, `sub:${e}`, {
              cause: t,
            });
          }
        },
    ...
    n("core/pubsubhub", { sub: Kt });
    const Qt = ["githubToken", "githubUser"];
    const Jt = new Map([
      ["text/html", "html"],
      ["application/xml", "xml"],
    ]);
  ...
  `;
    ...
    n("core/exporter", { rsDocToDataURL: Xt });
    class en {
      constructor() {
      ...
      async toHTML() {
        return Yt("html", document);
      }
    }
    const tn = "core/post-process";
    const nn = "core/pre-process";
    const rn = "core/base-runner";
    async function on(e) {
      (!(function () {
        const e = new en();
        Object.defineProperty(document, "respec", { value: e });
      })(),
        Zt("start-all", respecConfig),
        (function (e) {
          const t = {},
            n = e => Object.assign(t, e);
          (n(e),
            Kt("amend-user-config", n),
            Kt("end-all", () => {
              const e = document.createElement("script");
              ((e.id = "initialUserConfig"), (e.type = "application/json"));
              for (const e of Qt) e in t && delete t[e];
        ...
        (function (e) {
          ...
          (Object.assign(e, r), Zt("amend-user-config", r));
        })(respecConfig),
        performance.mark(`${rn}-start`),
        await (async function (e) {
          if (Array.isArray(e.preProcess)) {
            const t = e.preProcess.filter(e => {
              ...
              return (
                t ||
                  Dt("Every item in `preProcess` must be a JS function.", nn),
                t
              );
            });
            for (const [n, r] of t.entries()) {
              ...
              try {
                ...
                Dt(`Function ${t} threw an error during \`preProcess\`.`, nn, {
      ...
      (t.forEach(e => !e.name && console.warn("Plugin lacks name:", e)),
        ...
        await (async function (e) {
          if (Array.isArray(e.postProcess)) {
            const t = e.postProcess.filter(e => {
              ...
              return (
                t ||
                  Dt("Every item in `postProcess` must be a JS function.", tn),
                t
              );
            });
            for (const [n, r] of t.entries()) {
              ...
              try {
                ...
                Dt(`Function ${t} threw an error during \`postProcess\`.`, tn, {
                  hint: "See developer console.",
                  cause: e,
                });
              }
        ...
        Zt("end-all"),
        bt(document),
        performance.mark(`${rn}-end`),
        performance.measure(rn, `${rn}-start`, `${rn}-end`));
    }
    var sn = String.raw`.respec-modal .close-button{position:absolute;z-index:inherit;padding:.2em;font-weight:700;cursor:pointer;margin-left:5px;border:none;background:0 0}
...
.respec-plugin{text-align:right;color:rgb(120,120,120,.5);font-size:.6em}`;
    const an = /&gt;/gm,
      ln = /&amp;/gm;
    class cn extends ut.Renderer {
      code(e) {
        const { text: t, lang: n = "" } = e,
          { language: r, ...o } = cn.parseInfoString(n);
    ...
    const un = { gfm: !0, renderer: new cn() };
    function dn(e, t = { inline: !1 }) {
      const n = (function (e) {
          if (!e) return e;
          const t = e.trimEnd().split("\n"),
        ...
        r = n.replace(an, ">").replace(ln, "&");
      return t.inline ? ut.parseInline(r, un) : ut.parse(r, un);
    }
    function pn(e) {
      for (const t of e.getElementsByTagName("pre")) t.prepend("\n");
      e.innerHTML = dn(e.innerHTML);
    }
    const hn =
      ((fn = "[data-format='markdown']:not(body)"),
      e => {
        const t = e.querySelectorAll(fn);
        return (t.forEach(pn), Array.from(t));
      });
    var fn;
    var mn = Object.freeze({
      ...
      run: function (e) {
        const t = !!document.querySelector("[data-format=markdown]:not(body)"),
          n = "markdown" === e.format;
        if (!n && !t) return;
        if (!n) return void hn(document.body);
    ...
    const bn = lt`<div id="respec-ui" class="removeOnSave" hidden></div>`,
      yn = lt`<ul
  id="respec-menu"
  role="menu"
...
></ul>`,
      vn = lt`<button
  class="close-button"
  onclick=${() => Rn.closeModal()}
  title="Close"
>
  ❌
</button>`;
    let wn, kn;
    window.addEventListener("load", () => Cn(yn));
    const xn = [],
      $n = [],
      _n = {};
    (Kt("start-all", () => document.body.prepend(bn), { once: !0 }),
      Kt("end-all", () => document.body.prepend(bn), { once: !0 }));
    const Sn = lt`<button id="respec-pill" disabled>ReSpec</button>`;
    function En() {
      (yn.classList.toggle("respec-hidden"),
        yn.classList.toggle("respec-visible"),
        (yn.hidden = !yn.hidden));
    }
    function Cn(e) {
    ...
    (bn.appendChild(Sn),
      Sn.addEventListener("click", e => {
        (e.stopPropagation(),
          Sn.setAttribute("aria-expanded", String(yn.hidden)),
          En(),
          yn.querySelector("li:first-child button").focus());
      }),
      document.documentElement.addEventListener("click", () => {
        yn.hidden || En();
      }),
      bn.appendChild(yn),
      yn.addEventListener("keydown", e => {
        "Escape" !== e.key ||
          yn.hidden ||
          (Sn.setAttribute("aria-expanded", String(yn.hidden)),
          En(),
  ...
  ></button>`;
      ...
      const s = 1 === t.length ? pt.singular(r) : r;
      gn(o, new Map([["label", `${t.length} ${s}`]]));
    }
    gn(Sn, Ln);
    const Rn = {
      show() {
      ...
      addCommand(e, t, n, r) {
        ...
        const o = `respec-button-${e.toLowerCase().replace(/\s+/, "-")}`,
          s = lt`<button id="${o}" class="respec-option">
      <span class="respec-cmd-icon" aria-hidden="true">${r}</span> ${e}…
    </button>`,
          i = lt`<li role="menuitem">${s}</li>`;
        return (i.addEventListener("click", t), yn.appendChild(i), s);
      },
      error(e) {
        An(e, xn, "error", "ReSpec Errors");
      },
      warning(e) {
        An(e, $n, "warning", "ReSpec Warnings");
      },
      closeModal(e) {
        (kn &&
          (kn.classList.remove("respec-show-overlay"),
          kn.classList.add("respec-hide-overlay"),
          kn.addEventListener("transitionend", () => {
            (kn.remove(), (kn = null));
          })),
          e && e.setAttribute("aria-expanded", "false"),
          wn && (wn.remove(), (wn = null), Sn.focus()));
      },
      freshModal(e, t, n) {
        (wn && wn.remove(),
          kn && kn.remove(),
          (kn = lt`<div id="respec-overlay" class="removeOnSave"></div>`));
        const r = `${n.id}-modal`,
          o = `${r}-heading`;
        wn = lt`<div
      id="${r}"
    ...
    >
      ...
      <div class="inside">${t}</div>
        ...
        (gn(wn, s),
          document.body.append(kn, wn),
          kn.addEventListener("click", () => this.closeModal(n)),
          kn.classList.toggle("respec-show-overlay"),
          (wn.hidden = !1),
          Cn(wn));
      },
    };
    function Tn(e) {
      ...
      const t = e.plugin
          ...
          : "",
        n = e.hint
          ? `\n${dn(`<p class="respec-hint"><strong>How to fix:</strong> ${Gt(e.hint)}`, { inline: !e.hint.includes("\n") })}\n`
          : "",
        r = Array.isArray(e.elements)
          ? `<p class="respec-occurrences">Occurred <strong>${e.elements.length}</strong> times at:</p>\n    ${dn(e.elements.map(Pn).join("\n"))}`
          : "",
        o = e.details ? `\n\n<details>\n${e.details}\n</details>\n` : "";
      var s;
      return `${dn(`**${((s = e.message), s.replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/</g, "&lt;"))}**`, { inline: !0 })}${n}${r}${o}${t}`;
    }
    function Pn(e) {
    ...
    (document.addEventListener("keydown", e => {
      "Escape" === e.key && Rn.closeModal();
    }),
      (window.respecUI = Rn),
      Kt("error", e => Rn.error(e)),
      Kt("warn", e => Rn.warning(e)),
    ...
    var Dn = Object.freeze({
      ...
      run: function (e) {
        const t = !1 !== e.lint && { ...On.lint, ...qn.lint, ...e.lint };
        (Object.assign(e, { ...On, ...qn, ...e, lint: t }),
          Object.assign(
            e,
            (function (e) {
              return {
                isCCBY: "cc-by" === e.license,
                licenseInfo: zn.get(e.license),
    ...
    var Mn = String.raw`@keyframes pop{
...
.removeOnSave{display:none}
    ...
    const Wn = (function () {
        ...
        for (const n of e.map(gt)) t.appendChild(n);
        return t;
      })(),
      Gn = document.createElement("link");
    ((Gn.rel = "shortcut icon"),
      (Gn.type = "image/x-icon"),
      (Gn.href =
        "https://tools.geostandaarden.nl/respec/style/logos/Geonovum.ico"),
      document.head.prepend(Gn),
    ...
    var Vn = Object.freeze({
      ...
      run: function (e) {
        if (!e.specStatus) {
          ...
          ((e.specStatus = "GN-BASIS"), Mt(t, Fn));
        }
        document.body.querySelector("figure.scalable") &&
          (document.head.appendChild(Un("leaflet")),
          document.head.appendChild(Un("font-awesome")));
        let t = "";
    ...
    const Zn = {
      en: {
        status_at_publication: lt`This section describes the status of this
      ...
      nl: {
        status_at_publication: lt`Deze paragraaf beschrijft de status van dit
    ...
    Object.keys(Zn).forEach(e => {
      (o[e] || (o[e] = {}), Object.assign(o[e], Zn[e]));
    });
    var Kn = Object.freeze({ __proto__: null, name: "geonovum/l10n" });
    const Qn = "core/github";
    let Jn, Xn;
    const Yn = new Promise((e, t) => {
        ((Jn = e),
          (Xn = e => {
            (Dt(e, Qn), t(new Error(e)));
          }));
      }),
      er = $t({
        en: {
    ...
    var tr = Object.freeze({
      ...
      run: async function (e) {
        if (!e.hasOwnProperty("github") || !e.github) return void Jn(null);
        if (
          "object" == typeof e.github &&
          !e.github.hasOwnProperty("repoURL")
        ) {
          const e = Wt`Config option ${"[github]"} is missing property \`repoURL\`.`;
          return void Xn(e);
        }
        let t,
        ...
        try {
          ...
          const e = Wt`${"[github]"} configuration option is not a valid URL? (${n}).`;
          return void Xn(e);
        }
        if ("https://github.com" !== t.origin) {
          const e = Wt`${"[github]"} configuration option must be HTTPS and pointing to GitHub. (${t.href}).`;
          return void Xn(e);
        }
        const [r, o] = t.pathname.split("/").filter(e => e);
        if (!r || !o) {
          const e = Wt`${"[github]"} URL needs a path. For example, "w3c/my-spec".`;
          return void Xn(e);
        }
        const s = e.github.branch || "gh-pages",
        ...
        if (
          ...
          try {
            ...
            if ("https://github.com" !== e.origin) {
              const e = Wt`${"[github.pullsURL]"} must be HTTPS and pointing to GitHub. (${a}).`;
              return void Xn(e);
            }
            if (!e.pathname.includes("/pulls")) {
              const e = Wt`${"[github.pullsURL]"} must point to pull requests. (${a}).`;
              return void Xn(e);
            }
          } catch {
            const e = Wt`${"[github.pullsURL]"} is not a valid URL. (${a}).`;
            return void Xn(e);
          }
        if (
          ((l =
          ...
          try {
            const e = new URL(l);
            if ("https://github.com" !== e.origin) {
              const e = Wt`${"[github.commitHistoryURL]"} must be HTTPS and pointing to GitHub. (${l}).`;
              return void Xn(e);
            }
            if (!e.pathname.includes("/commits")) {
              const e = Wt`${"[github.commitHistoryURL]"} must point to commits. (${l}).`;
              return void Xn(e);
            }
          } catch {
            const e = Wt`${"[github.commitHistoryURL]"} is not a valid URL. (${l}).`;
            return void Xn(e);
          }
        const c = {
          edDraftURI: `https://${r.toLowerCase()}.github.io/${o}/`,
          githubToken: void 0,
          githubUser: void 0,
          issueBase: i,
          atRiskBase: i,
        ...
        if (!e.excludeGithubLinks) {
          const n = {
            key: er.participate,
            data: [
              { value: `GitHub ${r}/${o}`, href: t },
              { value: er.file_a_bug, href: c.issueBase },
              { value: er.commit_history, href: l },
    ...
    class nr {
      ...
      processHeader(e, t) {
        nr.sectionClasses.intersection(new Set(e.classList)).forEach(e => {
          t.classList.add(e);
        });
      }
      addSection(e) {
    ...
    function rr(e) {
      const t = new nr(e.ownerDocument);
      for (; e.firstChild; ) {
    ...
    const ir = "core/data-include";
    function ar(e, t, n) {
      const r = document.querySelector(`[data-include-id=${t}]`),
        o = _t(e, r.dataset.oninclude, n),
      ...
      const n = e.querySelectorAll("[data-include]"),
        r = Array.from(n).map(async e => {
          ...
          try {
            ...
            (ar(await o.text(), r, n), t < 3 && (await lr(e, t + 1)));
          } catch (t) {
            Dt(`\`data-include\` failed: \`${n}\` (${t.message}).`, ir, {
              elements: [e],
              cause: t,
            });
          }
    ...
    var dr = Object.freeze({
      ...
      run: function () {
        document.querySelectorAll("[data-transform]").forEach(e => {
          ((e.innerHTML = _t(e.innerHTML, e.dataset.transform)),
  ...
  >`;
    ...
    function Rr(e) {
      ...
      try {
        ...
        return (Dt(t.message, "core/inlines", { title: r, elements: [n] }), n);
      }
    ...
    const Tr = new Set(["alias", "reference"]),
      Pr = (async function () {
    ...
    const Nr = {
        ...
        async has(e, t) {
          if (!Tr.has(e)) throw new TypeError(`Invalid type: ${e}`);
        ...
        async addAll(e, t) {
          ...
          const r = [...Tr].flatMap(e => n[e].map(t => this.add(e, t)));
          await Promise.all(r);
        },
        async add(e, t) {
          if (!Tr.has(e)) throw new TypeError(`Invalid type: ${e}`);
      ...
      jr = {},
      Ir = new URL("https://api.specref.org/bibrefs?refs="),
      Or = gt({ hint: "dns-prefetch", href: Ir.origin });
    let zr;
    document.head.appendChild(Or);
    const qr = new Promise(e => {
      zr = e;
    });
    async function Dr(e, t = { forceUpdate: !1 }) {
      const n = [...new Set(e)].filter(e => e.trim());
      if (!n.length || !1 === navigator.onLine) return null;
      let r;
      try {
        r = await fetch(Ir.href + n.join(","));
      } catch (e) {
      ...
      try {
        const e = r.headers.has("Expires")
          ? Math.min(Date.parse(r.headers.get("Expires")), s)
          : s;
        await Nr.addAll(o, e);
      } catch (e) {
        console.error(e);
    ...
    async function Mr(e) {
      ...
      const n = t[e];
      return n.aliasOf ? await Mr(n.aliasOf) : n;
    }
    var Br = Object.freeze({
      ...
      Plugin: class {
        ...
        async run() {
          ...
          if (s.length) {
            const e = await Dr(s, { forceUpdate: !0 });
            Object.assign(jr, e);
          }
          (Object.assign(jr, this.conf.localBiblio),
            (() => {
              zr(this.conf.biblio);
            })());
        }
      ...
      name: "core/biblio",
      resolveRef: Mr,
      updateFromNetwork: Dr,
    });
    const Hr = "core/render-biblio",
      Fr = $t({
        en: {
    ...
    function Zr(e) {
      ...
      for (; t && t.aliasOf; )
        ...
        } else ((n = t.aliasOf), (t = jr[n]), r.add(n));
      return (
    ...
    function Jr(e) {
      ...
      return (
        ...
        e.authors &&
          ...
          e.etAl && (t += " et al"),
          t.endsWith(".") || (t += ". ")),
        e.publisher && (t = `${t} ${Wr(e.publisher)} `),
        e.date && (t += `${e.date}. `),
        e.status && (t += `${Ur.get(e.status) || e.status}. `),
      ...
      run: function (e) {
        ...
        if (
          (document.querySelector("section#references > :is(h2, h1)") ||
            r.prepend(lt`<h1>${Fr.references}</h1>`),
          r.classList.add("appendix"),
          n.length)
        ) {
          const e = Vr(n, Fr.norm_references);
          r.appendChild(e);
        }
        if (t.length) {
          const e = Vr(t, Fr.info_references);
          r.appendChild(e);
        }
        document.body.appendChild(r);
      },
    });
    const Yr = "core/inlines",
      eo = {},
      to = e => new RegExp(e.map(e => e.source).join("|")),
      no = $t({
        en: {
          rfc2119Keywords: () =>
            to([
  ...
  >`;
    ...
    function mo(e, t, n) {
      ...
      const [o, s] = r.split("|").map(xt),
        { type: i, illegal: a } = At(o, t.parentElement),
        l = Kr(o, s),
        c = o.replace(/^(!|\?)/, "");
    ...
    function yo(e) {
      const t = (function (e) {
          const t = e => e.replace("%%", "/").split("/").map(xt).join("/"),
            n = e.replace("\\/", "%%"),
            r = n.lastIndexOf("/");
          if (-1 === r) return [t(n)];
  ...
  >`;
    ...
    var ko = Object.freeze({
      ...
      run: function (e) {
        ...
        (document.normalize(),
          ...
          (e.normativeReferences = new Nt()),
          (e.informativeReferences = new Nt()),
          e.respecRFC2119 || (e.respecRFC2119 = eo));
        ...
        const r = t.size
          ...
          s = no.rfc2119Keywords(),
          i = new RegExp(
            `(${to([s, oo, so, io, ao, lo, ro, co, ...(r ? [r] : [])]).source})`
          );
        for (const n of o) {
    ...
    function xo(e, t, n, r) {
      try {
        ...
        Dt(`Invalid ${t} name "${e}": ${o.message}`, r, {
    ...
    const _o = new zt();
    function So(e, t) {
      for (const n of t) (_o.has(n) || _o.set(n, new Set()), _o.get(n).add(e));
    }
    const Eo = "core/dfn",
      Co = new Map([
        ...
        ["element", { requiresFor: !1, validator: xo }],
        ["element-attr", { requiresFor: !1, validator: xo }],
        [
          "element-state",
          {
            requiresFor: !0,
        ...
        ["event", { requiresFor: !1, validator: $o }],
        ...
        ["scheme", { requiresFor: !1, validator: $o }],
        [
          "permission",
          {
            requiresFor: !1,
    ...
    function Ao(e, t) {
      let n = "";
      switch (!0) {
        case Lo.some(t => e.classList.contains(t)):
          ((n = [...e.classList].find(e => Co.has(e))),
            (function (e, t, n) {
              const r = Co.get(t);
              if (r.requiresFor && !n.dataset.dfnFor) {
                const e = Wt`Definition of type "\`${t}\`" requires a ${"[data-dfn-for]"} attribute.`,
                  { associateWith: o } = r,
                  s = Wt`Use a ${"[data-dfn-for]"} attribute to associate this with ${o}.`;
                Dt(e, Eo, { hint: s, elements: [n] });
              }
              r.validator && r.validator(e, t, n, Eo);
            })(t, n, e));
          break;
        case mr.test(t):
          n = (function (e, t) {
            ...
            if (!t.dataset.dfnFor) {
              const n = Wt`Use a ${"[data-dfn-for]"} attribute to associate this dfn with a WebIDL interface.`;
              Dt(
            ...
            const o = ["attribute", "method"],
              { dfnType: s } = t.dataset;
            if (!o.includes(s) || r !== s) {
              const n = Wt`Invalid ${"[data-dfn-type]"} attribute on internal slot.`,
                s = `The only allowed types are: ${Ft(o, { quotes: !0 })}. The slot "${e}" seems to be a "${Ht(r)}"?`;
              return (Dt(n, Eo, { hint: s, elements: [t] }), "dfn");
            }
            return s;
          })(t, e);
      }
    ...
    function Ro(e) {
      switch (!0) {
        case e.matches(".export.no-export"):
          Dt(
            Wt`Declares both "${"[no-export]"}" and "${"[export]"}" CSS class.`,
            Eo,
        ...
        case e.matches(".no-export, [data-noexport]"):
          if (e.matches("[data-export]")) {
            (Dt(
              Wt`Declares ${"[no-export]"} CSS class, but also has a "${"[data-export]"}" attribute.`,
              Eo,
    ...
    var To = Object.freeze({
      ...
      run: function () {
        for (const e of document.querySelectorAll("dfn")) {
          const t = Ct(e);
          if ((So(e, t), e.dataset.cite && /\b#\b/.test(e.dataset.cite)))
            continue;
          const [n] = t;
          (Ao(e, n), Ro(e));
          const r = (e.dataset.localLt || "").split("|").map(xt),
            o = t.filter(e => !r.includes(e));
          (o.length > 1 || n !== xt(e.textContent)) &&
            (e.dataset.lt = o.join("|"));
        }
      },
    });
      ...
      run: function (e) {
        ...
        const t = (function () {
          ...
          document.querySelectorAll("a:not([href])").forEach(t => {
            const n = xt(t.textContent).toLowerCase();
          ...
          return (
            n.forEach(e => {
              const n = xt(e.textContent).toLowerCase();
              (t.add(n),
          ...
          .forEach(e => {
            ...
            if (r.size) {
              const t = e.dataset.plurals ? e.dataset.plurals.split("|") : [],
                n = [...new Set([...t, ...r])];
              ((e.dataset.plurals = n.join("|")), So(e, n));
            }
          });
      },
    });
    var No = String.raw`span.example-title{text-transform:none}
...
aside.example div.example{border-left-width:.1em;border-color:#999;background:#fff}`;
    ...
    <a class="self-link">${jo.example}<bdi>${r}</bdi></a
    >${o}
  </div>`;
    }
      ...
      ${No}
        ...
        e.forEach(e => {
          ...
          if ("aside" === e.localName) {
            ...
            const o = Io(e, t, n);
            e.prepend(o);
            const s = Et(e, "example", r || String(t));
            ...
            const i = Io(e, o ? 0 : t, n),
              a = lt`<div class="example" id="${s}">
        ${i} ${e.cloneNode(!0)}
      </div>`;
            Et(a, "example", r || String(t));
    ...
    var zo = String.raw`.issue-label{text-transform:initial}
...
.issue a.respec-gh-label{padding:5px;margin:0 2px 0 2px;font-size:10px;text-transform:none;text-decoration:none;font-weight:700;border-radius:4px;position:relative;bottom:2px;border:none;display:inline-block}`;
    ...
    function Mo(e, t, n) {
      ...
      (e.forEach(e => {
        ...
        if (!c) {
          const r = lt`<div class="${a ? `${s} atrisk` : s}" role="${"note" === s ? "note" : null}"></div>`,
            c = document.createElement("span"),
            p = lt`<div role="heading" class="${`${s}-title marker`}">${c}</div>`;
          Et(p, "h", s);
          let h,
            f = i;
          if (
            (e.id
              ...
              : Et(r, "issue-container", d.number ? `number-${d.number}` : ""),
            l)
          ) {
            if (
              ...
              if (
                ...
                Mt(`Failed to fetch issue number ${u}.`, qo);
              }
  ...
  >`;
        ...
        (function (e) {
          ...
          (e.hasChildNodes()
            ? t.append(e)
            : t.append(lt`<p>${Do.no_issues_in_spec}</p>`),
            (!n || (n && n !== t.firstElementChild)) &&
              t.insertAdjacentHTML(
                "afterbegin",
                `<h1>${Do.issue_summary}</h1>`
              ));
        })(o));
    }
              ...
              document.querySelectorAll("figure").forEach((t, n) => {
                ...
                if (r)
                  (!(function (e, t, n) {
                    ...
                    (Et(e, "fig", r),
                      Rt(t, lt`<span class="fig-title"></span>`),
                      t.prepend(
                        lt`<a class="self-link" href="#${e.id}"
      >${Zo.fig}<bdi class="figno">${n + 1}</bdi></a
    >`,
                        " "
                      ));
                  })(t, r, n),
                      ...
                      (function (e, t) {
                        ...
                        return (
                          n.querySelectorAll("a").forEach(e => {
                            Lt(e, "span").removeAttribute("href");
                          }),
                          lt`<li class="tofline">
    <a class="tocxref" href="${`#${e}`}">${n.childNodes}</a>
                  ...
                  Mt("Found a `<figure>` without a `<figcaption>`.", Vo, {
                    elements: [t],
                  });
                }
              }),
    ...
    async function Xo(e) {
      ...
      let s = "",
        i = "";
      if (t === Jo) s = document.location.href;
      else {
        const e = await Mr(t);
        if (!e) return null;
        ((s = e.href), (i = e.title));
      ...
      switch (e.localName) {
        ...
        case "dfn": {
          ...
          if (
            ...
            e.textContent ? Rt(e, t) : ((t.textContent = o), e.append(t)),
            s)
          ) {
          ...
          if ("export" in e.dataset) {
            (Dt("Exporting a linked external definition is not allowed.", Qo, {
    ...
    function rs(e) {
      ...
      if (n.startsWith("#") && !r) {
        const r = e.parentElement.closest('[data-cite]:not([data-cite^="#"])'),
          { key: o, isNormative: s } = r ? rs(r) : { key: Jo, isNormative: !1 };
        return (
          (t.cite = s ? o : `?${o}`),
    ...
    var ss = Object.freeze({
      ...
      run: async function () {
        ...
        await (async function (e) {
          const t = e
              .map(rs)
              .map(async e => ({ entry: e, result: await Mr(e.key) })),
            n = (await Promise.all(t))
              .filter(({ result: e }) => null === e)
              .map(({ entry: { key: e } }) => e),
            r = await Dr(n);
          r && Object.assign(jr, r);
        })([...e]);
        for (const t of e) {
        ...
        (function (e) {
          ...
          (function (e, t) {
            const n = e.textContent.trim(),
              ...
              o = ps(e) && ps(t, n);
            (r && !o) || Rt(e, document.createElement("code"));
          })(e, t),
        !r
      );
    }
    ...
    var fs = Object.freeze({
      __proto__: null,
      name: is,
      possibleExternalLinks: as,
      run: async function (e) {
        const t = (function () {
            const e = new zt();
            for (const t of _o.keys()) {
              const { result: n, duplicates: r } = cs(t);
              (e.set(t, n),
                r.length > 0 &&
                  Dt(ls.duplicateMsg(t), is, {
                    title: ls.duplicateTitle,
                    elements: r,
                  }));
            }
            return e;
        ...
        for (const e of r) {
          ...
          if (r) {
            ds(e, r, t) || as.push(e);
          } else "" === e.dataset.cite ? n.push(e) : as.push(e);
        }
        (hs(n),
          (function (e) {
            const { shortName: t = "" } = e,
            ...
            for (const t of r) {
              t.dataset.cite = t.dataset.cite.replace(n, `$1${Jo}$2`);
              const { key: r, isNormative: o } = rs(t);
              r !== Jo &&
    ...
    var gs = Object.freeze({
      ...
      run: async function (e) {
        ...
        if (!e.github) {
          return void Dt(
            Wt`Requested list of contributors from GitHub, but ${"[github]"} configuration option is not set.`,
            ms
          );
        }
        ...
        await (async function (e, t) {
          ...
          async function o() {
            ...
            try {
              ...
              return (
                Dt("Error loading contributors from GitHub.", ms, { cause: e }),
                null
              );
            }
          }
    ...
    function $s(e) {
      ...
      for (const e of t) {
        ...
        if (!ys.includes(r.localName)) continue;
      ...
      run: function (e) {
        if (
          ...
          (function () {
            ...
            if (!e.length) return;
            e.forEach(e => {
              const t = `h${Math.min(Tt(e, "section").length + 1, 6)}`;
              e.localName !== t && Lt(e, t);
            });
          })(),
          !e.noTOC)
        ) {
          ...
          const t = ks($s(document.body), e.maxTocLevel);
          t &&
            (function (e) {
              if (!e) return;
              const t = lt`<nav id="toc"></nav>`,
                n = lt`<h2 class="introductory">${ws.toc}</h2>`;
              (Et(n), t.append(n, e));
              const r =
    ...
    <a href="#title"><abbr title="${ws.back_to_top}">&uarr;</abbr></a>
  </p>`;
    ...
    var Cs = Object.freeze({
      ...
      run: function () {
        Array.from(document.querySelectorAll("section.informative"))
          ...
          .filter(e => e)
          .forEach(e => {
            e.after(lt`<p><em>${Es.informative}</em></p>`);
          });
      },
    });
    const Ls = $t({
    ...
    var As = Object.freeze({
      ...
      run: function (e) {
        ...
        for (const n of t) {
          let t = n.id;
          if (
            (t || (Et(n), (t = n.parentElement.id || n.id)), !e.addSectionLinks)
          )
            continue;
          const r = Ls.permalinkLabel(
  ...
  >`;
    ...
    var Is = Object.freeze({
      ...
      run: function (e) {
        ...
        ${Ns.map(t => js(t, e))}
              ...
              Rn.freshModal(Ps.save_snapshot, n, t);
            },
          },
    ...
    const Os = "https://respec.org/specref/",
      zs = $t({
  ...
  `;
          Rn.freshModal(zs.search_specref, e, qs);
        },
        "Ctrl+Shift+Alt+space",
        "🔎"
      );
    var Ds = Object.freeze({ __proto__: null });
    const Ms = $t({
    ...
    const Bs = document.createElement("div"),
      Hs = lt.bind(Bs),
      Fs = Rn.addCommand(
        `${Ms.about_respec} ${window.respecVersion}`,
        function () {
          const e = [];
...
`,
  ...
  `;
    ...
    var Ws = Object.freeze({ __proto__: null });
    var Gs = Object.freeze({
      __proto__: null,
      name: "core/seo",
      run: function (e) {
    ...
    var Vs = String.raw`.hljs{--base:#fafafa;--mono-1:#383a42;--mono-2:#686b77;--mono-3:#717277;--hue-1:#0b76c5;--hue-2:#336ae3;--hue-3:#a626a4;--hue-4:#42803c;--hue-5:#ca4706;--hue-5-2:#c91243;--hue-6:#986801;--hue-6-2:#9a6a01}
...
.hljs-link{text-decoration:underline}`;
    ...
    const Ks = new URL(
      ...
      Qs = gt({ hint: "preload", href: Ks, as: "script" });
    async function Js() {
      try {
        return (
        ...
        return Zs("worker/respec-worker.js");
      }
    }
    async function Xs() {
      try {
    ...
    const Ys = (async function () {
      const [e, t] = await Promise.all([Js(), Xs()]),
        n = new Blob(
          [
            null !== t
              ? `${t}\n`
    ...
    async function ti(e) {
      ...
      try {
        r = await (async function (e, t) {
          const n = { action: "highlight", code: e, id: ei(), languages: t },
            r = await Ys;
          return (
            r.postMessage(n),
            new Promise((e, t) => {
    ...
    var ni = Object.freeze({
      ...
      run: async function (e) {
        ...
        if (!t.length) return;
        const n = t.filter(e => e.textContent.trim()).map(ti);
    ...
    const ri = $t({
        en: {
          missing_test_suite_uri: Wt`Found tests in your spec, but missing ${"[testSuiteURI]"} in your ReSpec config.`,
          tests: "tests",
          test: "test",
        },
        ja: {
          missing_test_suite_uri: Wt`この仕様内にテストの項目を検出しましたが，ReSpec の設定に ${"[testSuiteURI]"} が見つかりません．`,
          tests: "テスト",
          test: "テスト",
        },
        de: {
          missing_test_suite_uri: Wt`Die Spezifikation enthält Tests, aber in der ReSpec-Konfiguration ist keine ${"[testSuiteURI]"} angegeben.`,
          tests: "Tests",
          test: "Test",
        },
        zh: {
          missing_test_suite_uri: Wt`本规范中包含测试，但在 ReSpec 配置中缺少 ${"[testSuiteURI]"}。`,
          tests: "测试",
          test: "测试",
        },
      }),
  ...
  `;
      ...
      return e
        .map(e => {
          try {
            ...
            Mt(Wt`Invalid URL in ${"[data-tests]"} attribute: ${e}.`, oi, {
              elements: [n],
            });
          }
        })
    ...
    function ai(e, t) {
      ...
      if (n.length) {
        const e = Wt`Duplicate tests found in the ${"[data-tests]"} attribute.`,
          r = Wt`To fix, remove duplicates from ${"[data-tests]"}: ${(function (
            e,
            { quotes: t } = { quotes: !1 }
          ) {
            return kt(e, t ? e => Ht(Ut(e)) : Ht);
          })(n, { quotes: !0 })}.`;
        Mt(e, oi, { hint: r, elements: [t] });
      }
    }
    function li(e) {
      const t = [...new Set(e)];
  ...
  `;
    ...
    var ci = Object.freeze({
      ...
      run: function (e) {
        ...
        if (t.length)
          ...
          else Dt(ri.missing_test_suite_uri, oi);
      },
    });
    const ui = "core/list-sorter";
    function di(e) {
    ...
    var fi = Object.freeze({
        ...
        for (const t of e) {
          ...
          switch (t.localName) {
            ...
            case "ul":
              ...
              break;
            default:
              Mt(`ReSpec can't sort ${t.localName} elements.`, ui, {
                elements: [t],
              });
          }
          if (e) {
      ...
      sortDefinitionTerms: hi,
      sortListItems: pi,
    });
    var mi = String.raw`var:hover{text-decoration:underline;cursor:pointer}
...
var.respec-hl{background:0 0;color:#000;box-shadow:unset}
    ...
    var gi = Object.freeze({
      ...
      run: async function (e) {
        ...
        ((t.textContent = mi), document.head.appendChild(t));
        ...
        ((n.id = "respec-highlight-vars"),
          (n.textContent = await (async function () {
            try {
              ...
              return Zs("./src/core/highlight-vars.runtime.js");
            }
          })()),
    ...
    var bi = String.raw`:root{--assertion-border:#aaa;--assertion-bg:#eee;--assertion-text:black}
...
:root{--assertion-border:#444;--assertion-bg:var(--borderedblock-bg);--assertion-text:var(--text)}
    ...
    var yi = Object.freeze({
      ...
      run: function () {
        ...
        const t = document.createElement("style");
        ((t.textContent = bi), document.head.appendChild(t));
      },
    });
    const vi = "core/anchor-expander";
    function wi(e, t, n) {
    ...
    function ki(e, t, n) {
      ...
      const o = [...jt(r.querySelector(".self-link")).childNodes].map(
        e => (e.classList?.remove("figno"), e)
      );
      (n.append(...o), n.classList.add("fig-ref"));
      const s = r.querySelector(".fig-title");
      !n.hasAttribute("title") && s && (n.title = xt(s.textContent));
    }
    function xi(e, t, n) {
    ...
    var Ci = String.raw`dfn{cursor:pointer}
...
.dfn-panel.docked{position:fixed;left:.5em;top:unset;bottom:2em;margin:0 auto;max-width:calc(100vw - .75em * 2 - .5em - .2em * 2);max-height:30vh;overflow:auto}`;
    function Li(e) {
      const { id: t } = e,
        ...
        s = e.getAttribute("aria-label") || xt(e.textContent),
        i = lt`
    <div
      class="dfn-panel"
      id="${o}"
      ...
      <li>Not referenced in this document.</li>
        ...
        t.forEach((t, r) => {
          ...
          const s = (function (e) {
            ...
            return n ? `§ ${xt(n.textContent)}` : null;
          })(t);
  ...
  `;
        ...
        ((n.id = "respec-dfn-panel"),
          (n.textContent = await (async function () {
            try {
              ...
              return Zs("./src/core/dfn-panel.runtime.js");
            }
          })()),
          document.body.append(n));
      },
    ...
    const Ti = "core/linter-rules/check-charset",
      Pi = $t({
        en: {
    ...
    var Ni = Object.freeze({
      ...
      run: function (e) {
        ...
        (n.includes("utf-8") && 1 === t.length) ||
          Mt(Pi.msg, Ti, { hint: Pi.hint, elements: [...t] });
      },
    });
    const ji = "core/linter-rules/check-punctuation",
      Ii = [".", ":", "!", "?"],
      Oi = Ii.map(e => `"${e}"`).join(", "),
      zi = $t({
        en: {
          msg: "`p` elements should end with a punctuation mark.",
          hint: `Please make sure \`p\` elements end with one of: ${Oi}.`,
        },
        cs: {
          msg: "Elementy `p` by měly končit interpunkčním znaménkem.",
          hint: `Ujistěte se, že elementy \`p\` končí jedním z těchto znaků: ${Oi}.`,
        },
      });
    var qi = Object.freeze({
      ...
      run: function (e) {
        ...
        const t = new RegExp(`[${Ii.join("")}\\]]$|^ *$`, "m"),
          n = [
            ...document.querySelectorAll("p:not(#back-to-top,#w3c-state)"),
          ].filter(e => !t.test(e.textContent.trim()));
        n.length && Mt(zi.msg, ji, { hint: zi.hint, elements: n });
      },
    });
    const Di = "core/linter-rules/local-refs-exist",
      Mi = $t({
        en: {
    ...
    var Hi = Object.freeze({
      ...
      run: function (e) {
        ...
        const t = [...document.querySelectorAll("a[href^='#']")].filter(Bi);
        t.length && Mt(Mi.msg, Di, { hint: Mi.hint, elements: t });
      },
    });
    const Fi = "core/linter-rules/no-headingless-sections",
      Ui = $t({
        en: {
    ...
    var Wi = Object.freeze({
      ...
      run: function (e) {
        ...
        t.length && Mt(Ui.msg, Fi, { hint: Ui.hint, elements: t });
      },
    });
    const Gi = "core/linter-rules/no-unused-vars",
      Vi = $t({
        en: {
    ...
    var Zi = Object.freeze({
      ...
      run: function (e) {
        ...
        t.length && Mt(Vi.msg, Gi, { hint: Vi.hint, elements: t });
      },
    });
    const Ki = "core/linter-rules/privsec-section",
      Qi = $t({
        en: {
    ...
    var Ji = Object.freeze({
      ...
      run: function (e) {
        ...
        e.lint?.["privsec-section"] &&
          ...
          Mt(Qi.msg, Ki, { hint: Qi.hint });
      },
    });
    const Xi = "core/linter-rules/no-http-props",
      Yi = $t({
        en: {
          msg: Wt`Insecure URLs are not allowed in ${"[respecConfig]"}.`,
          hint: "Please change the following properties to 'https://': ",
        },
        zh: {
          msg: Wt`${"[respecConfig]"} 中不允许使用不安全的URL.`,
          hint: "请将以下属性更改为 https://：",
        },
        cs: {
          msg: Wt`V ${"[respecConfig]"} nejsou povoleny nezabezpečené URL adresy.`,
