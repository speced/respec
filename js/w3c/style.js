        ...
        return {
            run:    function (conf, doc, cb, msg) {
                ...
                if (statStyle === "unofficial") {
                    css = conf.scheme + "://www.w3.org/StyleSheets/TR/w3c-unofficial";
                }
                else if (statStyle === "base") {
                    css = conf.scheme + "://www.w3.org/StyleSheets/TR/base";
                }
                    ...
                    css = conf.scheme + "://www.w3.org/community/src/css/spec/" + statStyle.toLowerCase() + ".css";
                }
                else {
                    css = conf.scheme + "://www.w3.org/StyleSheets/TR/W3C-" + statStyle;
                }
