...
const additions = {
  en: {
    status_at_publication: html`This section describes the status of this
      ...
      A list of current W3C publications and the latest revision
  ...
  es: {
    status_at_publication: html`Esta sección describe el estado del presente
      documento al momento de su publicación.
      Una lista de las publicaciones actuales del W3C y la
  ...
  de: {
    status_at_publication: html`Dieser Abschnitt beschreibt den Status des
      Dokuments zum Zeitpunkt der Publikation.
      Eine Liste der aktuellen Publikatinen des W3C und
