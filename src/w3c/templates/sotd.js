              ...
              conf.isSubmission
                ...
                `
                                      ...
                                      ${
                                        conf.isPER
                                          ? html`
                                              W3C Advisory Committee Members are
                                              invited to send formal review
                                              comments on this Proposed Edited
                                              Recommendation to the W3C Team
                                              until ${conf.humanPEREnd}. Members
                                              of the Advisory Committee will
                                              find the appropriate review form
                                              for this document by consulting
                                        ...
                                        conf.isPR
                                          ? html`
                                              ...
                                              <a
                                                ...
                                                >archives</a
                                              >) through ${conf.humanPREnd}.
                                              Advisory Committee Representatives
                                              should consult their
                                              <a
                                                href="https://www.w3.org/2002/09/wbs/myQuestionnaires"
                                                >WBS questionnaires</a
                                              >. Note that substantive technical
                                              comments were expected during the
                    ...
                    ${
                      conf.notRec
                        ? html`
                            <p>
                              Publication as ${conf.anOrA} ${conf.textStatus}
                      ...
                      conf.isRec
                        ? html`
                            <p>
                              ...
                              interested parties, and is endorsed by the
                              Director as a W3C Recommendation. It is a stable
                              document and may be used as reference material or
                              cited from another document. W3C's role in making
                              the Recommendation is to draw attention to the
                              specification and to promote its widespread
                    ...
                    <p data-deliverer="${conf.isNote ? conf.wgId : null}">
                      ...
                      ${
                        conf.isIGNote
                          ? html`
                              The disclosure obligations of the Participants of
                              this group are described in the
