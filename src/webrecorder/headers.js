...
export const name = "webrecorder/headers";

const status2text = {
  DRAFT: "Webrecorder Draft",
  REC: "Webrecorder Recommendation",
};

const WebrecorderDate = new Intl.DateTimeFormat(["en-US"], {
  timeZone: "UTC",
  year: "numeric",
  month: "long",
  day: "2-digit",
...
export function run(conf) {
  ...
  conf.publishHumanDate = WebrecorderDate.format(conf.publishDate);
