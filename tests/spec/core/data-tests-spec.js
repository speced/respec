...
describe("Core — data-tests attribute", () => {
  ...
  describe("generated test list", () => {
    ...
    it(`adds emojis for secure tests`, () => {
      ...
      const spanAriaLabel = li.children[1].children[0].getAttribute(
        "aria-label"
      );
    ...
    it(`adds emojis for secure manual tests`, () => {
      ...
      const spanAriaLabel1 = li.children[1].children[0].getAttribute(
        "aria-label"
      );
      ...
      const spanAriaLabel2 = li.children[1].children[1].getAttribute(
        "aria-label"
      );
