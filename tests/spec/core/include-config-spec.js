...
describe("Core — Include config as JSON", () => {
  ...
  test("should have a script tag with the correct attributes", async () => {
  ...
  test("includes config options from query parameters", async () => {
  ...
  test(
    "should have the same content for the config and the script's text",
    async () => {
