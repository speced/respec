...
describe("W3C — Headers", function() {
  ...
  it("should include the W3C Software and Document Notice and License (w3c-software-doc)", function(
    done
  ) {
    var ops = makeStandardOps();
    var newProps = {
  ...
  it("should take additionalCopyrightHolders into account when spec is unofficial", function(
    done
  ) {
    var ops = makeStandardOps();
    var newProps = {
  ...
  it("should handle additionalCopyrightHolders when text is markup", function(
    done
  ) {
    var ops = makeStandardOps();
    var newProps = {
